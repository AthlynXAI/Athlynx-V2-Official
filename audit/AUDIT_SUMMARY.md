...
2. **Authentication (Firebase)** — Firebase token verification via Google JWKS works without a service account file. Mobile auth via Firebase is clean and TS-clean.
