...
const PARTNER_EMAILS = [
  ...
  "tlockey24@athlynx.ai",          // Tony Locey — First Athlete Partner & Partner
];
...
const TEAM_PAYROLL: Array<{
  ...
  { name: "Tony Locey",   email: "tlockey24@athlynx.ai",         role: "First Athlete Partner & Partner",      percentageOfRevenue: 10 },
];
