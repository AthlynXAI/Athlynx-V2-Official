    ...
    <div className="min-h-screen bg-gradient-to-br from-[#07111f] via-[#0b1b34] to-[#0f3460] text-white">
      <header className="border-b border-white/10 bg-black/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <Link href="/digital-health" className="rounded-xl border border-cyan-300/30 px-4 py-2 text-sm font-bold text-cyan-200 hover:border-cyan-200 hover:text-white">
            Digital Health Hub
          </Link>
        </div>
      </header>
          ...
          {loading ? (
            ...
            <div className="rounded-2xl border border-white/10 bg-black/25 p-6">
              ...
              <div className="flex flex-col justify-center gap-3 sm:flex-row">
                <Link href="/signin" className="rounded-xl bg-cyan-400 px-6 py-3 font-black text-[#07111f] hover:bg-cyan-300">Sign In</Link>
