  ...
  const phases = [
    ...
    },
    {
      ...
      tasks: [
        ...
        "Set up Operations Command Hub for Lee Marshall",
      ...
      <section className="border-b bg-muted/30 py-12">
        <div className="container space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            A comprehensive 14-week plan to deploy the AI Bot Ecosystem across Dozier Holdings 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <ul className="space-y-2">
                      {phase.tasks.filter((t) => !isSuspended("Tony Locey") || !t.includes("Tony Locey")).map((task, taskIndex) => (
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-muted-foreground">
                <strong>Contact:</strong> contact@athlynx.ai
              </p>
            </div>
          </CardContent>
        </Card>
