/**
 * CricketElite — Canonical Less-Is-More sport page (Cricket)
 *
 * Generated from the DiamondGrind canonical template (Lane 4, 2026-05-19).
 * Hero: single H1 "The Cricket Playbook." · ONE CTA · corner BETA chip · full-bleed athlete media.
 *
 * Spec lock: docs/specs/SPORT_PAGE_DESIGN_SPEC.md
 * X-theme: black canvas, accent #16A34A, NO gold/yellow/amber.
...
// =====================================================================
// SPORT TOKEN — CricketElite (Cricket)
// =====================================================================
const SPORT = {
  name: "Cricket",
  pageTitle: "Cricket Elite",
  accent: "#16A34A",
  accentSoft: "rgba(22,163,74,0.12)",
  accentRing: "rgba(22,163,74,0.40)",
  emblem: "🏏",
  trpcSport: "Cricket",
  ctaLabel: "Get Assessed",
  heroPhoto: "/sport-hero/cricket-hero.jpg",
...
const PILLARS_BY_DISCIPLINE: Record<Discipline, { name: string; sample: number; pro: number; ncaa: number }[]> = {
  "Batting": [
    { name: "Stance", sample: 82, pro: 80, ncaa: 70 },
    { name: "Footwork", sample: 75, pro: 78, ncaa: 68 },
    { name: "Bat Swing", sample: 78, pro: 79, ncaa: 70 },
    { name: "Shot Sel.", sample: 74, pro: 78, ncaa: 69 },
  ],
  "Bowling": [
    { name: "Run Up", sample: 78, pro: 80, ncaa: 70 },
    { name: "Load", sample: 81, pro: 82, ncaa: 71 },
    { name: "Release", sample: 79, pro: 81, ncaa: 71 },
    { name: "Follow-Th.", sample: 76, pro: 80, ncaa: 70 },
  ],
  "Fielding": [
    { name: "Read", sample: 80, pro: 81, ncaa: 70 },
    { name: "Approach", sample: 73, pro: 79, ncaa: 68 },
    { name: "Catch", sample: 78, pro: 80, ncaa: 71 },
    { name: "Throw", sample: 76, pro: 80, ncaa: 70 },
  ],
};
...
const STATS_FIELDS = [
  { label: "Batting Avg", key: "battingAvg", placeholder: "42.5", group: "Batting" },
  { label: "Strike Rate", key: "strikeRate", placeholder: "128.4", group: "Batting" },
  { label: "Centuries", key: "centuries", placeholder: "3", group: "Batting" },
  { label: "Half-Centuries", key: "halfCenturies", placeholder: "12", group: "Batting" },
  { label: "Wickets", key: "wickets", placeholder: "48", group: "Bowling" },
  { label: "Economy", key: "economy", placeholder: "4.2", group: "Bowling" },
  { label: "Bowling Avg", key: "bowlingAvg", placeholder: "22.8", group: "Bowling" },
  { label: "Best Figures", key: "bestFigures", placeholder: "5/24", group: "Bowling" },
  { label: "Catches", key: "catches", placeholder: "14", group: "Fielding" },
  { label: "Run Outs", key: "runOuts", placeholder: "6", group: "Fielding" },
  { label: "Position", key: "position", placeholder: "All-rounder", group: "Fielding" },
  { label: "Sprint (m/s)", key: "sprintSpeed", placeholder: "8.4", group: "Physical" },
  { label: "Throw (mph)", key: "throwSpeed", placeholder: "78", group: "Physical" },
];

const STATS_GROUPS = ["Batting", "Bowling", "Fielding", "Physical"];

const PROGRAMS = [
  { title: "Elite Bowling Mechanics", level: "Elite", duration: "8 weeks", sessions: 24, desc: "Pace, swing, seam — biomechanics-driven." },
  { title: "Batting Power Development", level: "Intermediate", duration: "6 weeks", sessions: 18, desc: "Bat speed, shot selection, footwork." },
  { title: "Spin & Variation", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Wrist position, drift, dip, turn." },
  { title: "Fielding & Throwing", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Catching, ground fielding, throwing arm." },
  { title: "Mental Performance", level: "All Levels", duration: "Ongoing", sessions: null, desc: "Concentration, pressure rehearsal, captaincy." },
  { title: "National Squad Prep", level: "Elite", duration: "3 weeks", sessions: 9, desc: "USA Cricket · ICC pathways · trials-ready." },
];
