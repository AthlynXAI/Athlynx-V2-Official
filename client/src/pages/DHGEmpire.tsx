...
import {
  ...
  Server, TrendingUp, Target, Star, Rocket, MapPin, Mail,
  ArrowRight, CheckCircle2, Layers, BarChart3, Coins, Leaf, GraduationCap, Phone, Landmark
} from 'lucide-react';
...
const DIVISIONS = [
  ...
  { id: "finance", label: "Finance & Crypto", icon: <Trophy className="w-4 h-4" />, color: "from-red-500 to-red-600" },
        ...
        <div className="bg-gradient-to-br from-[#0a1628] to-[#0d1f4a] border border-red-500/20 rounded-3xl p-8 sm:p-12">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: <Trophy className="w-6 h-6" />, title: "One Vision", desc: "Every company serves one unified mission: empower athletes and build generational wealth." },
