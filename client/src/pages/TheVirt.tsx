      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Trophy, title: 'VR Training Simulations', desc: 'Immersive training environments for athletes to practice game situations, improve reaction time, and perfect technique.', link: '/training' },
