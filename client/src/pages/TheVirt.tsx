...
function TheVirtInner() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-[#1E90FF] to-slate-900 text-white">
      <header className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link href="/dhg-home"><button className="flex items-center gap-2 text-[#1E90FF] hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" /> DHG Empire</button></Link>
        </div>
      </header>
      <section className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-[#1E90FF]/40 border border-[#1E90FF]/30 rounded-full px-4 py-2 text-[#1E90FF] text-sm mb-6"><Building2 className="w-4 h-4" /> A DOZIER HOLDINGS GROUP COMPANY</div>
          <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-[#1E90FF] to-[#0a1628] rounded-2xl flex items-center justify-center"><Monitor className="w-10 h-10 text-white" /></div>
          <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight"><span className="bg-gradient-to-r from-[#1E90FF] to-[#0a1628] bg-clip-text text-transparent">THE VIRT</span></h1>
          <p className="text-xl text-[#1E90FF] mb-2 font-bold">Virtual Reality & Immersive Experiences</p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/training"><button className="bg-gradient-to-r from-[#1E90FF] to-[#0a1628] hover:from-[#1E90FF] hover:to-[#0a1628] text-white font-bold px-8 py-3 rounded-xl transition-all">Explore Training <ChevronRight className="inline w-4 h-4" /></button></Link>
            <Link href="/dhg"><button className="border border-[#1E90FF] text-[#1E90FF] hover:bg-[#1E90FF]/40 font-bold px-8 py-3 rounded-xl transition-all">DHG Corporate</button></Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Link key={i} href={s.link}><div className="bg-slate-800/60 border border-slate-700 rounded-2xl p-6 hover:border-[#1E90FF]/50 hover:bg-slate-800/80 transition-all cursor-pointer group">
                <s.icon className="w-8 h-8 text-[#1E90FF] mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-bold text-lg mb-2">{s.title}</h3>
                <p className="text-gray-400 text-sm">{s.desc}</p>
                <div className="mt-4 flex items-center gap-1 text-[#1E90FF] text-sm font-semibold">Learn More <ChevronRight className="w-4 h-4" /></div>
              </div></Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/dhg-home"><button className="bg-[#1E90FF] hover:bg-[#1E90FF] text-white font-bold px-6 py-3 rounded-xl transition-all">View All Companies</button></Link>
