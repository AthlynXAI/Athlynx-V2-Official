  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#07111f] via-[#0b1b34] to-[#102a4f] text-white">
      ...
      <main className="px-4 py-16 md:py-20">
        ...
        <section className="mx-auto mb-8 max-w-5xl rounded-2xl border border-amber-300/30 bg-amber-400/10 p-6 text-left">
          <h2 className="mb-3 text-2xl font-black text-amber-100">Medical Safety Boundary</h2>
