...
const mississippiChampionshipWatch = [
  ...
  { label: "Southern Miss Baseball", detail: "Hattiesburg Regional host · Pete Taylor Park · Base Burg energy", tone: "border-amber-300/30 bg-amber-400/10" },
...
const dataSourceModel = [
  ...
  { label: "Projection", detail: "D1Baseball, Baseball America, Warren Nolan, and other projection outlets until NCAA confirms the field." },
  ...
  return (
    <main className="min-h-screen bg-[#030814] text-white">
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-4 py-12 lg:grid-cols-3">
        ...
        <div className="rounded-3xl border border-amber-300/20 bg-[#07142c] p-6 shadow-2xl shadow-blue-950/40">
          <Crown className="mb-4 h-8 w-8 text-amber-300" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="rounded-3xl border border-amber-300/30 bg-gradient-to-br from-[#18110a] to-[#07142c] p-6">
            <div className="mb-6 flex items-center gap-3">
              <Star className="h-8 w-8 text-amber-300" />
              <div>
                <div className="text-xs font-black uppercase tracking-[0.25em] text-amber-200">Profile money layer</div>
      ...
      <section className="border-y border-amber-300/20 bg-gradient-to-br from-[#0a1224] via-[#07142c] to-[#150f08] px-4 py-12">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-300/40 bg-amber-300/10 px-4 py-2 text-xs font-black uppercase tracking-[0.25em] text-amber-200">
...
Diamond Grind and Softball Nation are the seasonal front doors right now. The page uses original bracket cards and source links instead of screenshot graphics, then turns fan calls into public feed engagement, NIL Messenger sharing, and year-over-year championship data.
          ...
          <div className="grid gap-4 md:grid-cols-4">
            {omahaTimeline.map((item, index) => (
              <div key={item.phase} className="rounded-3xl border border-white/10 bg-black/25 p-5 shadow-xl shadow-black/20">
                ...
                <div className="mt-2 text-xs font-black uppercase tracking-[0.18em] text-amber-200">{item.timing}</div>
          ...
          <div className="mt-10 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-3xl border border-amber-300/20 bg-black/25 p-5">
              <div className="mb-4 flex items-center justify-between gap-3">
                <div>
                  <div className="text-xs font-black uppercase tracking-[0.22em] text-amber-200">Mississippi championship watch</div>
                  <h3 className="mt-2 text-2xl font-black">The Magnolia State is all over the hunt</h3>
                </div>
                <span className="rounded-full bg-amber-300/10 px-3 py-1 text-[11px] font-black uppercase text-amber-100">Respect all · pull for all</span>
              </div>
          ...
          <div className="mt-10 rounded-3xl border border-cyan-300/20 bg-[#061126] p-5">
            <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <span className="rounded-full border border-amber-300/40 bg-amber-300/10 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-amber-100">Official links · original cards</span>
            </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-amber-300/20 bg-amber-400/10 p-4">
                <h4 className="font-black text-amber-100">Feed and share cards</h4>
                <p className="mt-2 text-sm text-amber-50/80">Regional wins, Super Regional clinches, Omaha appearances, honors, and highlight moments become cross-share assets.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#030814] px-4 py-12">
        <div className="mx-auto max-w-7xl rounded-3xl border border-white/10 bg-gradient-to-r from-blue-950 to-slate-950 p-6">
          <div className="grid gap-6 md:grid-cols-4">
            ...
            <div className="flex gap-3"><CalendarDays className="h-6 w-6 text-amber-300" /><div><h3 className="font-black">Calendar drives growth</h3><p className="mt-1 text-sm text-blue-200">Schedules, championships, visits, and camps create repeat usage.</p></div></div>
