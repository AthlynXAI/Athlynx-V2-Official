...
function PartnerPortalInner() {
  ...
  const getAccessLevelColor = (level: string) => {
    switch (level) {
      case "executive": return "bg-[#1E90FF]/20 text-[#1E90FF] border-[#1E90FF]/30";
      case "premium": return "bg-blue-600/20 text-blue-500 border-blue-600/30";
      default: return "bg-[#1E90FF]/20 text-[#00C2FF] border-[#1E90FF]/30";
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A1628] via-[#0D1E36] to-[#0A1628]">
      {/* Header */}
      <div className="border-b border-[#1E90FF]/30 bg-[#0A1628]/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#1E90FF]/20 to-blue-600/20 border border-[#1E90FF]/30 flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <Card className="bg-[#0D1E36]/80 border-[#1E90FF]/30">
              <CardHeader>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-all ${
                      selectedCategory === cat.id
                        ...
                        : "text-gray-400 hover:bg-[#1E90FF]/20 hover:text-white"
                    }`}
                  >
            ...
            {/* Quick Stats */}
            <Card className="bg-[#0D1E36]/80 border-[#1E90FF]/30 mt-6">
              <CardHeader>
              ...
              <CardContent>
                {docsLoading ? (
                  <div className="text-center py-12">
                    <div className="w-8 h-8 border-2 border-[#1E90FF] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
                  ...
                  <div className="space-y-4">
                    {documents.map((doc: Document) => (
                      <div
                        key={doc.id}
                        className="flex items-center justify-between p-4 rounded-lg bg-[#0A1628] border border-[#1E90FF]/30 hover:border-[#1E90FF]/30 transition-all"
                      >
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-lg bg-[#1E90FF]/20 flex items-center justify-center">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-3 mt-2">
                              <Badge variant="outline" className="text-xs border-[#1E90FF]/30 text-[#00C2FF]">
                                {doc.category}
                              </Badge>
