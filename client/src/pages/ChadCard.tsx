        ...
        <div className="pt-14 pb-4 px-5 text-center">
          ...
          <div className="mt-3 text-left bg-gradient-to-r from-[#b80000] to-[#8b0000] rounded-xl p-3 shadow-md relative overflow-hidden">
            ...
            <div className="relative">
              <div className="text-[10px] font-black tracking-widest uppercase text-[#FFD700] mb-1">Two-Sport Athlete · FB + Baseball · 1989–1993</div>
              ...
              <p className="text-[11px] text-white/90 leading-relaxed mt-2">
                Played quarterback on <span className="font-bold text-[#FFD700]">R.H. Watkins Stadium / George Blair Field</span> —
                the locals just call it <span className="font-bold text-[#FFD700]">“The Bricks.”</span>
