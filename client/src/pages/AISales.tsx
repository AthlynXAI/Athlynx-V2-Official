            ...
            <div className="bg-[#0d1f3c] border border-cyan-900 rounded-xl p-5">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { tier: "Mid-Tier Athlete", followers: "50K–500K", icon: "🔥", color: "border-blue-400/40", rates: [
...
[Instagram Handle] | [Email] | [Phone]` },
                  { subject: "Re: NIL Partnership — [Your Name] Follow-Up", type: "Follow-Up", icon: "🔄", color: "border-blue-400/40",
                    body: `Hi [Name],
