...
import { Brain, CheckCircle, Shield, Server, Activity, Trophy, Lock, FileText, Users, Rocket, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#061120] via-[#0b2140] to-[#08111f] text-white">
      ...
      <main className="px-4 py-16 md:py-20">
        <section className="mx-auto mb-14 max-w-6xl text-center">
          {/* Nebius Semifinalist Banner */}
          <div className="mb-8 mx-auto max-w-3xl rounded-2xl border border-blue-400/40/40 bg-blue-900/30/10 px-6 py-5 flex items-center gap-4 shadow-xl shadow-blue-500/20">
            <Star className="h-8 w-8 flex-shrink-0 text-blue-300" />
            <div className="text-left">
              <p className="text-xs font-bold uppercase tracking-widest text-blue-300 mb-1">Official Recognition</p>
              <p className="text-lg font-black text-white leading-tight">Nebius AI Discovery Awards 2026 — Digital Health <span className="text-blue-300">Semifinalist</span></p>
              <p className="text-sm text-gray-300 mt-1">198 semifinalists selected from 646 submissions (top 30%) · Ceremony: July 1, 2026 · King's Cross, London</p>
            </div>
          </div>
        ...
        <section className="mx-auto mb-14 max-w-7xl rounded-3xl border border-white/10 bg-white/5 p-7">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <div className="rounded-2xl bg-black/20 p-5">
              ...
              <p className="leading-relaxed text-gray-300">Confirmed <span className="font-bold text-blue-300">Semifinalist</span> — Nebius AI Discovery Awards 2026, Digital Health category. 198 of 646 submissions selected. Finalist announcement expected June 2026. Prepared around Digital Health, real-world data intelligence, MVP proof, GPU-scale AI infrastructure, anonymized data posture, and July 1 ceremony readiness.</p>
            </div>
            <div className="rounded-2xl bg-black/20 p-5">
