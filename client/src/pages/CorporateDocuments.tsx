...
import { Building, FileText, Users, Download, ExternalLink, Calendar, MapPin } from "lucide-react";

function CorporateDocumentsInner() {
  const companies = [
    {
      name: "Dozier Holdings LLC",
  ...
  const boardMembers = [
    { name: "Chad A. Dozier", role: "Founder / Owner", since: "2024" },
    { name: "Glenn Tse", role: "Finance & Operations", since: "2025" },
    { name: "Governance seats", role: "Gated until formal approval", since: "Private" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white">
      ...
      <section className="py-12 px-4 bg-slate-800/30">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Governance Snapshot</h2>
      ...
      <footer className="bg-slate-900 border-t border-slate-800 py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-slate-400 text-sm">© 2026 Dozier Holdings LLC. All rights reserved.</p>
        </div>
      </footer>
    <MobileBottomNav />
    </div>
