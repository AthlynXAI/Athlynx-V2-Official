...
const NOTIF_CONFIG: Record<string, { icon: React.ElementType; color: string; bg: string; label: string }> = {
  welcome:             { icon: Star,         color: "text-blue-300", bg: "bg-blue-900/30/20",  label: "Welcome" },
  ...
  new_feature:         { icon: Flame,        color: "text-blue-400", bg: "bg-blue-500/20", label: "New" },
  promotion:           { icon: Gift,         color: "text-pink-400",   bg: "bg-pink-500/20",   label: "Promo" },
  reminder:            { icon: Clock,        color: "text-blue-300", bg: "bg-blue-900/30/20", label: "Reminder" },
  achievement:         { icon: Trophy,       color: "text-blue-300", bg: "bg-blue-900/30/20", label: "Achievement" },
