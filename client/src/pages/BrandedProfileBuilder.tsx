  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-950 to-black text-white">
      ...
      <section className="relative px-6 pt-14 pb-10 text-center max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-blue-600/20 to-cyan-500/20 border border-cyan-400/30 text-xs font-bold tracking-widest text-cyan-300 mb-5">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
          ...
          youth, high school, college, pro. Your <span className="text-cyan-300 font-bold">Top 5 schools</span> live
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        <div className="rounded-3xl overflow-hidden border border-gray-800 bg-gradient-to-b from-gray-900 to-black shadow-2xl">
          ...
          <div className="bg-gradient-to-r from-gray-900 to-black px-4 py-2 flex items-center justify-between border-b border-gray-800">
            ...
            <span className="text-[10px] text-cyan-400 font-bold tracking-widest">LIVE PREVIEW</span>
          </div>

          <div className="p-6 md:p-8">
            <div className="text-xs font-black tracking-widest uppercase text-cyan-300 mb-3">
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        <div className="flex items-end justify-between mb-4">
          <div>
            <div className="text-xs font-black tracking-widest uppercase text-cyan-300">Step 1</div>
            ...
            return (
              ...
              >
                <div className="aspect-square flex flex-col items-center justify-center p-2 relative">
                  ...
                  {selected && (
                    <div className="absolute top-1 right-1 w-4 h-4 bg-cyan-400 rounded-full flex items-center justify-center text-[10px] font-black text-black">
                      ✓
                    </div>
                  )}
                </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-10">
        <div className="text-xs font-black tracking-widest uppercase text-cyan-300 mb-3">Step 2</div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <div key={c.t} className="rounded-2xl border border-gray-800 bg-gray-900/40 p-5">
              <div className="text-sm font-black text-cyan-300 mb-1">{c.t}</div>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-12">
        <div className="rounded-3xl border border-cyan-400/30 bg-gradient-to-r from-cyan-500/10 via-blue-600/10 to-teal-500/10 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <div className="text-xs font-black tracking-widest uppercase text-cyan-300 mb-1">NIL Pipeline</div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/ai-trainer/build" className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-gradient-to-r from-green-400 to-emerald-500 text-black font-black tracking-wider uppercase text-sm hover:scale-[1.02] transition-transform">
              Start AI Trainer →
            </Link>
            <Link href="/nil-portal" className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 text-black font-black tracking-wider uppercase text-sm hover:scale-[1.02] transition-transform">
              Open NIL Portal →
            </Link>
          </div>
        </div>
