    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] flex items-center justify-center p-4">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8 max-w-md w-full text-center">
          ...
          <LoginButton className="inline-block px-8 py-3 bg-gradient-to-r from-[#1E90FF] to-[#0a1628] text-white font-bold rounded-xl hover:opacity-90 transition-all">
            Sign In with AthlynX
          </LoginButton>
          <p className="text-gray-500 text-sm mt-4">
            <Link href="/" className="text-[#00C2FF] hover:underline">← Back to Home</Link>
          </p>
        </div>
      </div>
    );
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Link href="/dashboard" className="text-[#1E90FF] font-semibold">Dashboard</Link>
          </nav>
          <div className="flex items-center gap-3">
            ...
            {user.avatarUrl ? (
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#1E90FF] to-blue-500 flex items-center justify-center text-white font-bold text-sm">
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
            {/* Cover banner */}
            <div className="h-28 bg-gradient-to-r from-blue-900 via-[#1E90FF] to-blue-900 relative">
              {myProfile?.coverUrl && (
                <img src={myProfile.coverUrl} alt="Cover" className="w-full h-full object-cover absolute inset-0" />
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
              {isFounderIdentity && (
                <div className="absolute top-3 right-3 bg-[#1E90FF] text-white text-[10px] font-black px-2 py-0.5 rounded-full tracking-widest uppercase">
                  FOUNDER
                </div>
              )}
            </div>
            ...
            <div className="px-5 pb-5">
              <div className="flex items-end justify-between -mt-10 mb-3">
                {/* Avatar */}
                <div className="w-20 h-20 rounded-full border-4 border-[#1a1a2e] overflow-hidden bg-gradient-to-br from-[#1E90FF] to-blue-600 flex items-center justify-center shrink-0">
                  {user.avatarUrl ? (
                ...
                <div className="flex gap-2 pb-1">
                  <a href="/profile" className="bg-[#1E90FF] hover:bg-[#1E90FF] text-black text-xs font-black px-4 py-2 rounded-full transition-all">
                    Edit Profile
                  </a>
                  <a href="/epx" className="bg-white/10 hover:bg-white/20 border border-white/20 text-white text-xs font-bold px-4 py-2 rounded-full transition-all">
                    Athlete Feed
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 flex-wrap mb-1">
                ...
                <svg className="w-5 h-5 text-[#00C2FF]" fill="currentColor" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg>
                {isFounderIdentity ? (
                  <span className="text-[10px] font-black bg-[#1E90FF]/20 text-[#1E90FF] border border-[#1E90FF]/30 px-2 py-0.5 rounded-full uppercase tracking-wider">Founder · CEO · Chairman</span>
                ) : user.role === "admin" ? (
                  <span className="text-[10px] font-black bg-[#1E90FF]/20 text-[#00C2FF] border border-[#1E90FF]/30 px-2 py-0.5 rounded-full uppercase tracking-wider">Team Admin</span>
                ) : null}
              </div>
              {/* Sport / School / Position */}
              <div className="text-[#00C2FF] text-sm mb-2">
              ...
              {myProfile && (
                <div className="mt-3 space-y-3">
                  ...
                  {(myProfile as any).coachViews > 0 && (
                    <div className="flex items-center gap-3 bg-gradient-to-r from-blue-900/60 to-[#0a1628]/40 border border-[#1E90FF]/30 rounded-xl p-3">
                      <div className="relative shrink-0">
                        <div className="w-12 h-12 bg-blue-700/50 rounded-xl flex items-center justify-center">
                          <svg className="w-6 h-6 text-[#00C2FF]" fill="currentColor" viewBox="0 0 24 24"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
                        </div>
                        <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#1E90FF] rounded-full flex items-center justify-center text-white text-[10px] font-black">{(myProfile as any).coachViews}</span>
                      </div>
                      <div>
                        <div className="text-white font-black text-sm">{(myProfile as any).coachViews} COACHES VIEWED YOUR PROFILE TODAY</div>
                        <div className="text-[#00C2FF] text-xs">Your recruiting profile is getting attention </div>
                      </div>
                    </div>
                  )}
                  {/* Sport Stats */}
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {(myProfile as any).nilVerified && (
                          <span className="flex items-center gap-1 text-[10px] font-black text-[#00C2FF] bg-[#1E90FF]/20 border border-[#1E90FF]/30 px-2 py-0.5 rounded-full">
              ...
              {(myProfile?.instagram || myProfile?.twitter) && (                <div className="flex gap-3 flex-wrap">
                  ...
                  <a href="/community-feedback"
                    className="flex items-center gap-1.5 text-xs text-[#00C2FF] hover:text-[#00C2FF] bg-[#1E90FF]/20 border border-[#1E90FF]/30 px-3 py-1.5 rounded-full transition-all">
                     Talk to the Founder
                  </a>
                </div>
              )}
            ...
            <div className="flex-1">
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-5">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="px-2 py-1 bg-[#1E90FF]/20 text-[#1E90FF] rounded text-xs font-semibold uppercase">
                          {planName}
                        </span>
                      </div>
                      {subLoading ? (
                      ...
                      <div className="space-y-3">
                        {notifications.slice(0, 5).map((n: any) => (
                          ...
                          >
                            ...
                            {n.isRead === "no" && (
                              <span className="w-2 h-2 rounded-full bg-[#1E90FF] flex-shrink-0" />
                            )}
                          </div>
                        ))}
                      </div>
                  ...
                  {nilDeals && nilDeals.length > 0 && (
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-5">
                      ...
                      <Link
                        href="/nil-portal"
                        className="block mt-4 text-center text-[#00C2FF] hover:underline text-sm"
                      >
                        View All NIL Deals →
                      </Link>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                    ...
                    {subLoading ? (
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                          {plans?.map((plan) => (
                            ...
                            >
                              ...
                              <p className="text-2xl font-bold text-[#00C2FF] mb-1">
                              ...
                              <button
                                ...
                                className="w-full py-2 bg-[#1E90FF] text-white font-semibold rounded-lg hover:bg-[#1E90FF] transition-all text-sm disabled:opacity-50"
                              >
                                Subscribe
                              </button>
                            </div>
                      ...
                      /* Active plan */
                      <div className="bg-gradient-to-r from-[#1E90FF]/20 to-[#0a1628]/20 rounded-xl p-6 mb-6">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-[#1E90FF] font-semibold mb-1">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="text-right">
                        <p className="text-3xl font-bold text-[#00C2FF]">{aiCredits}</p>
                      ...
                      {creditPacks?.map((pack) => (
                        <div
                          ...
                          className={`relative rounded-xl p-5 border ${
                            pack.credits === 500
                              ? "bg-gradient-to-br from-[#1E90FF]/20 to-blue-500/20 border-[#1E90FF]/30"
                              : "bg-white/5 border-white/10"
                          }`}
                        >
                          {pack.credits === 500 && (
                            <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-3 py-0.5 bg-[#1E90FF] text-black text-xs font-bold rounded-full">
                              BEST VALUE
                            </span>
                          )}
                          ...
                          <p className="text-xl font-bold text-[#00C2FF] text-center mb-4">
                          ...
                          <button
                            ...
                            className={`w-full py-2 rounded-lg font-semibold transition-all disabled:opacity-50 ${
                              pack.credits === 500
                                ? "bg-[#1E90FF] text-black hover:bg-[#1E90FF]"
                      ...
                      <div className="grid md:grid-cols-2 gap-2 text-sm">
                        {[
                          ...
                          <div key={i} className="flex items-center justify-between text-gray-400">
                            ...
                            <span className="text-[#00C2FF]">{item.credits} credits</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    {statsLoading ? (
                      ...
                      <div className="grid md:grid-cols-4 gap-4 mb-6">
                        {[
                          ...
                          { label: "Total Minutes",  value: trainingStats?.totalMinutes ?? 0,  icon: "" },
                    ...
                    {!trainingHistory || trainingHistory.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <Link
                          ...
                          className="inline-block mt-3 px-4 py-2 bg-[#1E90FF] text-black font-semibold rounded-lg text-sm"
                        >
                          Start Training →
                        </Link>
                      </div>
                      ...
                      <div className="space-y-3">
                        {trainingHistory.map((log: any) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              {log.duration && (
                                <p className="text-[#00C2FF] text-sm">{log.duration} min</p>
                              )}
                              {log.performance && (
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                  ...
                  {!nilDeals || nilDeals.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <Link
                        href="/nil-portal"
                        className="inline-block px-6 py-2 bg-[#1E90FF] text-white font-semibold rounded-lg hover:bg-[#1E90FF] transition-all"
                      >
                        Explore NIL Portal →
                      </Link>
                    </div>
                  ...
                  <Link
                    href="/nil-portal"
                    className="block mt-6 text-center text-[#00C2FF] hover:underline"
                  >
                      ...
                      {athletes.map((athlete: any) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-[#0a1628] flex items-center justify-center text-white font-bold overflow-hidden">
                              {athlete.avatarUrl ? (
                                <img
                          ...
                          <div className="flex items-center gap-3">
                            {athlete.nilValue && athlete.nilValue > 0 && (
                              <span className="text-[#00C2FF] font-bold text-sm">
              ...
              {activeTab === "settings" && (
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#1E90FF]"
                        />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#1E90FF] resize-none"
                      ...
                      <button
                        ...
                        className="px-6 py-2 bg-[#1E90FF] text-black font-semibold rounded-lg hover:bg-[#1E90FF] transition-all disabled:opacity-50"
                      >
                  ...
                  <div className="bg-[#1E90FF]/10 backdrop-blur-sm rounded-xl border border-[#1E90FF]/20 p-6">
                    <h3 className="text-lg font-bold text-[#1E90FF] mb-2">Danger Zone</h3>
                    <p className="text-gray-400 text-sm mb-4">
                      Once you delete your account, there is no going back.
                    </p>
                    <button className="px-6 py-2 bg-[#1E90FF]/20 text-[#1E90FF] font-semibold rounded-lg hover:bg-[#1E90FF]/30 transition-all">
                      Delete Account
                    </button>
                  </div>
                </div>
