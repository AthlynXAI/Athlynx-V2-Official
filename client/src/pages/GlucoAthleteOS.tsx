...
const alerts = [
  { label: "Current glucose", value: "92 mg/dL", status: "Practice recovery", tone: "text-[#00C2FF]" },
  { label: "Trend", value: "Rising slowly", status: "Fuel response detected", tone: "text-[#00C2FF]" },
  { label: "Data freshness", value: "1 minute", status: "Primary device still required", tone: "text-blue-200" },
  { label: "Escalation", value: "Parent + trainer", status: "Consent-controlled", tone: "text-[#00C2FF]" },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#06111f] via-[#0a1d35] to-[#123766] text-white">
      <header className="border-b border-white/10 bg-black/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          ...
          <nav className="hidden items-center gap-5 text-sm md:flex">
            ...
            <Link href="/competition-readiness" className="rounded-xl bg-[#1E90FF] px-4 py-2 font-black text-[#07111f] hover:bg-[#1E90FF]">Nebius Readiness</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="px-4 py-12 md:py-16">
        <section className="mx-auto grid max-w-7xl items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
              <span className="mb-5 inline-flex rounded-full border border-[#1E90FF]/30 bg-[#1E90FF]/20 px-4 py-1 text-sm font-black uppercase tracking-[0.24em] text-[#00C2FF]">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#live-demo" className="rounded-xl bg-[#1E90FF] px-6 py-3 font-black text-[#07111f] transition hover:bg-[#1E90FF]">
          ...
          <div id="live-demo" className="rounded-[2rem] border border-[#1E90FF]/30 bg-black/35 p-5 shadow-2xl shadow-cyan-950/40">
            <div className="mb-4 flex items-center justify-between">
              <div>
                <p className="text-sm font-black uppercase tracking-[0.22em] text-[#00C2FF]">Live demo state</p>
                <h2 className="text-3xl font-black">Practice Recovery</h2>
              </div>
              <div className="rounded-2xl border border-[#1E90FF]/30 bg-[#1E90FF]/10 px-4 py-2 text-sm font-black text-[#00C2FF]">
                Safe Mode
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-[#071527] p-5">
              <div className="mb-4 flex items-end justify-between">
                ...
                <HeartPulse className="h-12 w-12 text-[#00C2FF]" />
              </div>
              ...
              <p className="mt-4 rounded-2xl border border-blue-300/20 bg-blue-400/10 p-4 text-sm font-bold leading-relaxed text-[#00C2FF]">
        ...
        <section className="mx-auto mt-10 max-w-7xl rounded-[2rem] border border-[#1E90FF]/30 bg-gradient-to-r from-[#1E90FF]/20 via-blue-500/10 to-emerald-400/10 p-7 shadow-2xl shadow-cyan-950/40">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#00C2FF]">Universal BioSignal Channel</p>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {channelSignals.map((signal) => (
              <span key={signal} className="rounded-full border border-white/10 bg-black/30 px-4 py-2 text-sm font-black text-[#00C2FF]">{signal}</span>
            ))}
          </div>
        </section>
        ...
        <section className="mx-auto mt-14 max-w-7xl">
          <div className="mb-6 flex items-end justify-between gap-4">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.22em] text-[#00C2FF]">Baked into AthlynXAI OS v1</p>
            ...
            <Shield className="hidden h-14 w-14 text-[#00C2FF] md:block" />
          </div>
          <div className="mb-8 grid gap-5 md:grid-cols-2 xl:grid-cols-5">
            {ecosystemLegs.map((leg) => (
              <article key={leg.code} className="rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/10 transition hover:border-[#1E90FF]/30">
                <p className="text-sm font-black uppercase tracking-[0.2em] text-[#00C2FF]">{leg.code}</p>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {systemLayers.map((layer) => {
              ...
              return (
                <article key={layer.title} className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/10 transition hover:border-[#1E90FF]/30">
                  <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#1E90FF]/20">
                    <Icon className="h-7 w-7 text-[#00C2FF]" />
                  </div>
        ...
        <section id="safety" className="mx-auto mt-14 grid max-w-7xl gap-6 lg:grid-cols-2">
          <article className="rounded-[2rem] border border-[#1E90FF]/20 bg-[#1E90FF]/10 p-7">
            <div className="mb-4 flex items-center gap-3">
              <CheckCircle2 className="h-8 w-8 text-[#00C2FF]" />
              <h2 className="text-3xl font-black">Build now</h2>
            </div>
            <p className="text-lg leading-relaxed text-[#00C2FF]">
          ...
          <article className="rounded-[2rem] border border-blue-300/20 bg-blue-400/10 p-7">
            <div className="mb-4 flex items-center gap-3">
        ...
        <section className="mx-auto mt-14 max-w-7xl rounded-[2rem] border border-[#1E90FF]/20 bg-[#1E90FF]/10 p-7">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#00C2FF]">Tonight test route</p>
          ...
          <p className="mt-4 max-w-4xl text-lg leading-relaxed text-[#00C2FF]">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <code className="rounded-2xl border border-white/10 bg-black/40 p-4 text-sm font-bold text-[#00C2FF]">POST /api/glucoathlete/connections/create-code</code>
            <code className="rounded-2xl border border-white/10 bg-black/40 p-4 text-sm font-bold text-[#00C2FF]">GET /api/glucoathlete/readings/latest</code>
            <code className="rounded-2xl border border-white/10 bg-black/40 p-4 text-sm font-bold text-[#00C2FF]">GET /api/glucoathlete/readings/series</code>
            <code className="rounded-2xl border border-white/10 bg-black/40 p-4 text-sm font-bold text-[#00C2FF]">GET /api/mcp/glucoathlete</code>
          </div>
        </section>

        <section className="mx-auto mt-14 max-w-7xl rounded-[2rem] border border-white/10 bg-black/30 p-7">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#00C2FF]">Nebius and OpenAI lanes</p>
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            <div className="rounded-2xl border border-[#1E90FF]/30 bg-[#1E90FF]/20 p-6">
              <Zap className="mb-4 h-9 w-9 text-[#00C2FF]" />
        ...
        <section className="mx-auto mt-14 max-w-7xl">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#00C2FF]">Roadmap</p>
