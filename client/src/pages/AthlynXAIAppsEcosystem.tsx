...
import { AppWindow, Archive, Bot, ClipboardCheck, Database, Lock, ShieldCheck, UserCheck, Workflow, Trophy } from "lucide-react";
        ...
        <section className="mx-auto max-w-6xl">
          ...
          <Card className="mt-6 border-white/10 bg-white/[0.04]">
            <CardContent className="grid gap-5 p-6 md:grid-cols-3 md:p-8">
              ...
              <ProofTile icon={Trophy} title="Live product map" copy="Each rail links to a deployed route or controlled operating surface." />
