 ...
 *
 * Market penetration structure modeled after Under Armour.
    ...
    <PlatformLayout title="Athlete Store">
      <div className="max-w-6xl mx-auto px-2 py-4 space-y-4">
        ...
        <div className="relative rounded-2xl overflow-hidden" style={{height: '200px'}}>
          <img
            src="/media/championship-brand/episode-2/scene11-store-hero.jpg"
            alt="AthlynX Store — One Identity. Every Athlete. Every Platform."
            className="w-full h-full object-cover object-top"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#020810]/85 via-[#020810]/40 to-transparent" />
          <div className="absolute bottom-4 left-4">
            <div className="text-[10px] font-black text-blue-400 tracking-widest uppercase mb-1">AthlynX Store</div>
            <div className="text-white font-black text-2xl leading-tight">Gear. Built Different.</div>
            <div className="text-blue-300 text-xs font-semibold mt-0.5">Official AthlynX performance gear. Engineered for athletes. Worn by difference makers.</div>
          </div>
        </div>
            ...
            <div key={product.id} className="bg-[#0d1b3e] rounded-2xl border border-blue-800 overflow-hidden hover:border-blue-600 transition-all group">
              ...
              <div className="bg-gradient-to-br from-blue-900/50 to-indigo-900/50 p-6 text-center relative">
                ...
                {product.badge && (
                  <span className={`absolute top-2 left-2 text-[9px] font-black px-1.5 py-0.5 rounded-full text-white ${
                    product.badge === "BESTSELLER" ? "bg-blue-600" :
                    product.badge === "NEW" ? "bg-green-600" :
                    product.badge === "AI-POWERED" || product.badge === "AI" ? "bg-purple-600" :
                    product.badge === "ELITE" || product.badge === "PRO" ? "bg-blue-900/30" :
                    "bg-blue-600"
                  }`}>
                    {product.badge}
                  </span>
              ...
              <div className="p-3">
                ...
                <div className="flex items-center gap-1 mb-2">
                  <div className="flex text-blue-300 text-xs">
        ...
        {/* NIL Merch CTA */}
        <div className="bg-gradient-to-r from-blue-500/40 to-blue-900/40 rounded-2xl border border-blue-400/40/50 p-5 text-center">
          ...
          <a
            ...
            className="inline-block px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-500 text-white font-black rounded-xl text-sm hover:opacity-90 transition-all"
          >
