  ...
  return (
    <PlatformLayout title="Athlete Store">
      <div className="max-w-6xl mx-auto px-2 py-4 space-y-4">
              ...
              <div className="bg-gradient-to-br from-blue-900/50 to-indigo-900/50 p-6 text-center relative">
                ...
                {product.badge && (
                  <span className={`absolute top-2 left-2 text-[9px] font-black px-1.5 py-0.5 rounded-full text-white ${
                    product.badge === "BESTSELLER" ? "bg-cyan-600" :
        ...
        {/* NIL Merch CTA */}
        <div className="bg-gradient-to-r from-blue-900/40 to-cyan-900/40 rounded-2xl border border-blue-700/50 p-5 text-center">
          ...
          <a
            ...
            className="inline-block px-6 py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-black rounded-xl text-sm hover:opacity-90 transition-all"
          >
