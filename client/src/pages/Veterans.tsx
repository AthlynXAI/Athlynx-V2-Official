...
import { ArrowLeft, Shield, Star, Heart, Users, Briefcase, GraduationCap, Home, Bot, DollarSign, CheckCircle2, Flag, Award, Target, Trophy } from "lucide-react";
            ...
            <div className="bg-slate-900/50 rounded-2xl border border-slate-700 p-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { type: "Endorsement Deal", range: "$5,000 - $100,000+", icon: Trophy }
                ].map((opp, index) => (
            ...
            <CardContent className="p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  { label: "Health Monitoring", icon: Trophy }
                ].map((item, index) => (
