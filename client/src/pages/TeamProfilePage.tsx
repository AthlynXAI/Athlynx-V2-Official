      ...
      <div className="mx-auto max-w-3xl px-5 py-10">
        ...
        {!profile ? (
          ...
          >
            ...
            <Link href="/team">
              <a className="mt-5 inline-block rounded-xl bg-[#1E90FF] px-5 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-white hover:bg-[#0080FF]">
                View Full Team \u2192
              </a>
            </Link>
          </div>
          ...
          <>
            ...
            <div className="mt-8 text-center">
              <Link href="/team">
                <a className="text-[11px] font-black uppercase tracking-[0.18em] text-white/60 hover:text-[#1E90FF]">
                  \u2190 Back to Full Team
                </a>
              </Link>
            </div>
