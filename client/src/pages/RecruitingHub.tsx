...
const SHOWCASE_SCHOOLS = [
  { name: "University of Alabama", conference: "SEC", division: "Division I", sport: "Football", scholarships: 85, avgGPA: 3.1, ranking: 4, logo: "", color: "from-[#1E90FF] to-[#0a1628]", state: "AL" },
  { name: "Ohio State University", conference: "Big Ten", division: "Division I", sport: "Football", scholarships: 85, avgGPA: 3.3, ranking: 3, logo: "", color: "from-[#1E90FF] to-gray-800", state: "OH" },
  ...
  { name: "LSU", conference: "SEC", division: "Division I", sport: "Football", scholarships: 85, avgGPA: 3.0, ranking: 5, logo: "", color: "from-[#1E90FF] to-blue-900", state: "LA" },
  { name: "Stanford University", conference: "Pac-12", division: "Division I", sport: "Soccer", scholarships: 9.9, avgGPA: 3.9, ranking: 1, logo: "", color: "from-[#1E90FF] to-gray-800", state: "CA" },
  ...
  { name: "University of Texas", conference: "Big 12", division: "Division I", sport: "Football", scholarships: 85, avgGPA: 3.2, ranking: 6, logo: "", color: "from-[#1E90FF] to-gray-800", state: "TX" },
  { name: "Florida State University", conference: "ACC", division: "Division I", sport: "Track & Field", scholarships: 12.6, avgGPA: 3.3, ranking: 7, logo: "", color: "from-[#1E90FF] to-blue-900", state: "FL" },
];
...
const STATUS_COLORS: Record<string, string> = {
  received: "bg-[#00C2FF]/20 text-[#00C2FF] border-[#00C2FF]/30",
  pending: "bg-blue-500/20 text-[#00C2FF] border-blue-500/30",
  accepted: "bg-blue-500/20 text-blue-400 border-blue-500/30",
  declined: "bg-[#1E90FF]/20 text-[#1E90FF] border-[#1E90FF]/30",
};
...
function RecruitingHubInner() {
  ...
  const TIMELINE_EVENTS = [
    { date: "Mar 15, 2026", event: "Received offer from University of Alabama", type: "offer", icon: "", color: "text-[#00C2FF]" },
    { date: "Mar 20, 2026", event: "Received offer from Ohio State University", type: "offer", icon: "", color: "text-[#00C2FF]" },
    { date: "Mar 25, 2026", event: "Official visit to University of Alabama", type: "visit", icon: "", color: "text-blue-400" },
    { date: "Apr 1, 2026", event: "Received offer from University of Texas", type: "offer", icon: "", color: "text-[#00C2FF]" },
    { date: "Apr 10, 2026", event: "Official visit to Ohio State University", type: "visit", icon: "", color: "text-blue-400" },
    { date: "Apr 15, 2026", event: "Declined LSU offer", type: "decision", icon: "", color: "text-[#1E90FF]" },
    { date: "May 1, 2026", event: "Deadline: Alabama offer expires", type: "deadline", icon: "", color: "text-[#00C2FF]" },
    { date: "May 8, 2026", event: "National Signing Day", type: "milestone", icon: "", color: "text-[#00C2FF]" },
  ];
      ...
      <div className="max-w-5xl mx-auto px-2 py-4 space-y-4 pb-24">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {[
                  { label: "Offers Received", value: "3", color: "text-[#00C2FF]" },
                  { label: "Schools Interested", value: "8", color: "text-[#00C2FF]" },
                  { label: "Coaches Contacted", value: "12", color: "text-[#1E90FF]" },
                  { label: "Recruiting Score", value: "94", color: "text-[#00C2FF]" },
                ].map((s, i) => (
            ...
            {!user && (
              <Link href="/signup">
                <button className="bg-gradient-to-r from-[#1E90FF] to-blue-600 text-white font-black px-4 py-2.5 rounded-xl text-sm hover:opacity-90 transition-all shrink-0">
                  Join Free →
                </button>
              </Link>
            )}
        ...
        {activeTab === "offers" && (
          <div className="space-y-3">
              ...
              <div key={i} className="bg-[#0d1b3e] rounded-2xl border border-blue-800 p-4 hover:border-blue-600 transition-all">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    <div className="text-[#00C2FF] font-black text-base">{offer.value}</div>
                ...
                <div className="flex items-center justify-between text-xs text-blue-400 border-t border-blue-900/50 pt-2">
                  ...
                  <span className={offer.status === "received" ? "text-[#00C2FF] font-bold" : ""}>
                ...
                {offer.status === "received" && (
                  <div className="flex gap-2 mt-3">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-[#00C2FF] to-emerald-600 text-white font-black py-2 rounded-xl text-xs hover:opacity-90 transition-all"
                    >
                       Accept
                    </button>
                    <button
                      onClick={() => toast.info(`Declined offer from ${offer.school}`)}
                      className="flex-1 bg-[#1E90FF]/30 border border-[#1E90FF] text-[#1E90FF] font-black py-2 rounded-xl text-xs hover:bg-[#1E90FF]/50 transition-all"
                    >
                       Decline
                    </button>
            ...
            {!user && (
              <div className="bg-gradient-to-r from-[#1E90FF]/20 to-blue-900/30 rounded-2xl border border-[#1E90FF]/30 p-5 text-center">
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-[#0d1b3e] border border-blue-800 text-white text-sm rounded-xl pl-9 pr-3 py-2.5 focus:outline-none focus:border-[#1E90FF]"
                />
              </div>
              <select
                value={selectedSport}
                onChange={e => setSelectedSport(e.target.value)}
                className="bg-[#0d1b3e] border border-blue-800 text-blue-400 text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:border-[#1E90FF]"
              >
            ...
            {filteredCoaches.map((coach, i) => (
              <div key={i} className="bg-[#0d1b3e] rounded-2xl border border-blue-800 p-4 hover:border-blue-600 transition-all">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-[#0a1628] flex items-center justify-center text-2xl shrink-0">
                    {coach.avatar}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-white font-black text-base">{coach.name}</span>
                      <span className="bg-[#00C2FF]/20 text-[#00C2FF] text-[9px] font-black px-1.5 py-0.5 rounded-full border border-[#00C2FF]/30">
                        RECRUITING
                      </span>
                    </div>
                  ...
                  <div className="text-right">
                    <div className="text-[#00C2FF] font-black text-sm">{coach.scholarshipsAvailable}</div>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-[#1E90FF] to-blue-600 text-white font-black py-2.5 rounded-xl text-xs hover:opacity-90 transition-all"
                    >
                       Contact Coach
                    </button>
                  </a>
        ...
        {activeTab === "eligibility" && (
          <div className="space-y-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className={`text-[10px] font-black px-2 py-0.5 rounded-full border ${
                        item.status === "eligible" ? "bg-[#00C2FF]/20 text-[#00C2FF] border-[#00C2FF]/30" :
                        item.status === "not-entered" ? "bg-blue-500/20 text-blue-400 border-blue-500/30" :
                        "bg-[#1E90FF]/20 text-[#1E90FF] border-[#1E90FF]/30"
                      }`}>
                        {item.status === "eligible" ? " ELIGIBLE" : item.status === "not-entered" ? "ℹ N/A" : " REVIEW"}
                      </span>
                    </div>
            ...
            <div className="bg-gradient-to-r from-[#1E90FF]/20 to-blue-900/30 rounded-2xl border border-[#1E90FF]/30 p-4 text-center">
              ...
              <Link href="/athlete-legal-hub">
                <button className="px-5 py-2 bg-gradient-to-r from-[#1E90FF] to-blue-600 text-white font-black rounded-xl text-xs hover:opacity-90 transition-all">
