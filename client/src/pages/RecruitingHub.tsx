...
const SHOWCASE_SCHOOLS = [
  ...
  { name: "LSU", conference: "SEC", division: "Division I", sport: "Football", scholarships: 85, avgGPA: 3.0, ranking: 5, logo: "🐯", color: "from-purple-900 to-blue-300", state: "LA" },
  ...
  { name: "Vanderbilt University", conference: "SEC", division: "Division I", sport: "Baseball", scholarships: 11.7, avgGPA: 3.6, ranking: 8, logo: "⭐", color: "from-blue-500 to-gray-800", state: "TN" },
  { name: "University of Texas", conference: "Big 12", division: "Division I", sport: "Football", scholarships: 85, avgGPA: 3.2, ranking: 6, logo: "🤘", color: "from-blue-900 to-gray-800", state: "TX" },
  { name: "Florida State University", conference: "ACC", division: "Division I", sport: "Track & Field", scholarships: 12.6, avgGPA: 3.3, ranking: 7, logo: "🏹", color: "from-red-900 to-blue-300", state: "FL" },
];
...
const STATUS_COLORS: Record<string, string> = {
  ...
  pending: "bg-blue-900/30/20 text-blue-300 border-blue-400/40/30",
...
function RecruitingHubInner() {
  ...
  const TIMELINE_EVENTS = [
    ...
    { date: "May 1, 2026", event: "Deadline: Alabama offer expires", type: "deadline", icon: "⏰", color: "text-blue-400" },
    { date: "May 8, 2026", event: "National Signing Day", type: "milestone", icon: "🏆", color: "text-blue-300" },
  ];
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {[
                  ...
                  { label: "Recruiting Score", value: "94", color: "text-blue-300" },
                ].map((s, i) => (
            ...
            {SHOWCASE_OFFERS.map((offer, i) => (
              <div key={i} className="bg-[#0d1b3e] rounded-2xl border border-blue-800 p-4 hover:border-blue-600 transition-all">
                ...
                <div className="flex items-center justify-between text-xs text-blue-400 border-t border-blue-900/50 pt-2">
                  ...
                  <span className={offer.status === "received" ? "text-blue-400 font-bold" : ""}>
            ...
            {filteredCoaches.map((coach, i) => (
              <div key={i} className="bg-[#0d1b3e] rounded-2xl border border-blue-800 p-4 hover:border-blue-600 transition-all">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="text-right">
                    <div className="text-blue-300 font-black text-sm">{coach.scholarshipsAvailable}</div>
