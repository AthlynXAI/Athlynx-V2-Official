...
function WellnessPortalInner() {
  ...
  const audiences = [
    { id: 'athletes', label: 'Athletes', icon: Activity, color: 'from-cyan-500 to-blue-500' },
    ...
    { id: 'medical', label: 'Medical Professionals', icon: Heart, color: 'from-red-500 to-red-500' }
  ];
