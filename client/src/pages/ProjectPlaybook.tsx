...
const farmSystem = [
  {
    ...
    level: "AAA",
    description: "AthlynXAI LLM integration, credit purchases, usage tracking",
    priority: "HIGH"
  },
  {
        ...
        {activeTab === "bench" && (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">White-Label Sport Platforms - Live Pages Built</p>
            </div>
