...
import { Briefcase, DollarSign, Star, MapPin, Calendar, CheckCircle, ArrowRight, Users, Award, Target, BookOpen, Zap, Globe, Building, Mic, Camera, Code, ChartBar, Heart, Shield, Clock, Lightbulb, GraduationCap, TrendingUp } from "lucide-react";
...
const CAREER_PATHS = [
  ...
  },
  {
    ...
    desc: "YouTube, TikTok, podcasting. Your athletic brand has built-in audience.",
    avgSalary: "$20K–$5M+",
    demand: "Growing",
    color: "red"
  },
                ...
                <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-5 hover:bg-white/10 transition-all cursor-pointer">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`text-xs font-bold px-2 py-1 rounded-full ${
                      path.demand === "Explosive" ? "bg-blue-900/30/20 text-blue-300" :
