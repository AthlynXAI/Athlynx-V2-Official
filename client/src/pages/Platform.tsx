    ...
    <div className="min-h-screen relative text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a1628]/95 backdrop-blur-md border-b border-[#1E90FF]/30">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/">
              <button className="bg-gradient-to-r from-[#1E90FF] to-blue-600 hover:from-[#1E90FF] hover:to-blue-500 text-white font-bold px-6 py-2 rounded-lg shadow-lg shadow-cyan-500/30 transition-all">
                HOME
              </button>
            </Link>
          </div>
      ...
      <div className="relative w-full max-w-[1200px] mx-auto px-4 pt-24 pb-12 space-y-16">
        ...
        <div className="text-center space-y-6">
          <div className="inline-block px-4 py-2 bg-[#1E90FF]/20 border border-[#1E90FF]/30 rounded-full">
            <span className="text-[#00C2FF] font-bold text-sm tracking-wider"> THE PLATFORM</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-black tracking-tight">
            <span className="bg-gradient-to-r from-[#1E90FF] via-blue-400 to-[#0a1628] bg-clip-text text-transparent">
              AthlynX
            </span>
          </h1>
          
          <p className="text-xl md:text-2xl text-[#00C2FF] font-bold tracking-wide">
        ...
        <div className="space-y-8">
          <div className="text-center">
            ...
            <p className="text-[#00C2FF]">Everything you need to build your athletic brand</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-slate-800/50 backdrop-blur-sm border border-[#1E90FF]/30 rounded-xl p-6 hover:border-[#1E90FF] hover:shadow-lg hover:shadow-cyan-500/20 transition-all group"
              >
        ...
        <div className="space-y-8">
          <div className="text-center">
            ...
            <p className="text-[#00C2FF]">Tailored experiences for every sport</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {platforms.map((platform, index) => (
              <div 
                key={index}
                className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-[#1E90FF]/30 rounded-xl p-6 hover:border-[#1E90FF] hover:shadow-lg hover:shadow-cyan-500/20 transition-all text-center group"
              >
                ...
                <p className="text-[#00C2FF] text-sm font-semibold mb-2">{platform.sport}</p>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-[#1E90FF]/20 to-blue-500/20 border border-[#1E90FF]/30 rounded-2xl p-12 text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/">
              <button className="bg-gradient-to-r from-[#1E90FF] to-blue-600 hover:from-[#1E90FF] hover:to-blue-500 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-cyan-500/30 transition-all text-lg">
                 CLAIM YOUR VIP SPOT
              </button>
            </Link>
            <Link href="/pricing">
              <button className="bg-slate-800/80 hover:bg-slate-700/80 border border-[#1E90FF]/30 hover:border-[#1E90FF] text-white font-bold px-8 py-4 rounded-xl transition-all text-lg">
                View Pricing
              </button>
            </Link>
          </div>
