...
const PUBLIC_LAYERS = [
  ...
  },
  {
    ...
    color: "border-[#1E90FF] bg-[#1E90FF]/20",
  ...
  },
  {
    ...
    color: "border-[#00C2FF] bg-[#00C2FF]/10",
    titleColor: "text-[#00C2FF]",
    items: [
...
const PUBLIC_STATS = [
  { label: "Platform", value: "Live", icon: "", color: "text-[#00C2FF]" },
  { label: "Blueprint", value: "Private", icon: "", color: "text-[#00C2FF]" },
  { label: "Athletes", value: "First", icon: "", color: "text-[#00C2FF]" },
  { label: "Inquiry", value: "Open", icon: "", color: "text-blue-400" },
];
      ...
      <div className="max-w-6xl mx-auto px-2 py-4 space-y-6">
        <div className="bg-gradient-to-br from-[#0a0f1e] via-[#0d1b3e] to-[#1a3a8f] rounded-2xl border border-blue-700 p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-[#1E90FF]/20 border border-[#1E90FF]/30 rounded-full px-4 py-1.5 text-[#00C2FF] text-xs font-black mb-4 tracking-widest">
...
The CERN of US Sports Tech
        ...
        <div className="rounded-2xl border-2 border-[#00C2FF] bg-[#00C2FF]/20 p-4 flex items-center gap-4">
          <div className="text-3xl"></div>
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              <span className="text-white font-black text-sm">CONFIDENTIAL ARCHITECTURE PROTECTED</span>
              <span className="text-[10px] font-black px-2 py-0.5 rounded-full border bg-[#00C2FF]/20 border-[#00C2FF] text-[#00C2FF]"> LIVE</span>
            </div>
          ...
          <div className="text-right shrink-0">
            <div className="text-[#00C2FF] font-black text-sm">PRIVATE</div>
            <div className="text-[#00C2FF] text-[10px]">IP LOCKED</div>
          </div>
        </div>
              ...
              <div key={i} className="bg-[#0d1b3e] rounded-2xl border border-blue-800 overflow-hidden hover:border-blue-600 transition-all">
                <div className={`bg-gradient-to-r ${engine.color} p-4 flex items-center justify-between`}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="bg-[#00C2FF]/20 border border-[#00C2FF] text-[#00C2FF] text-[9px] font-black px-2 py-0.5 rounded-full"> LIVE</span>
                  </div>
                </div>
                    ...
                    <div key={j} className="bg-[#0d1b3e]/80 rounded-xl border border-blue-900 p-3 flex items-start gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                          ...
                          <span className="text-[#00C2FF] text-[9px] font-black"> ACTIVE</span>
                        </div>
        ...
        <div className="bg-gradient-to-br from-[#0a0f1e] to-[#1a1a2e] rounded-2xl border border-[#1E90FF]/30 p-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Athlete platform", "NIL readiness", "Recruiting visibility", "Private architecture", "Partner inquiry"].map((tag) => (
                  <span key={tag} className="bg-[#1E90FF]/20 border border-[#1E90FF]/30 text-[#00C2FF] text-[10px] font-bold px-2 py-1 rounded-full">{tag}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <Link key={link.href} href={link.href}>
              <div className="bg-[#0d1b3e] rounded-xl border border-blue-800 p-3 text-center hover:border-[#1E90FF] hover:bg-blue-900/30 transition-all cursor-pointer">
