...
const championshipVisuals = [
  ...
  { src: "/media/championship-brand/episode-2/scene03-football-equipment.png", title: "Football equipment", use: "Football, NIL, team store" },
...
const styles: Record<string, CSSProperties> = {
  ...
  gateStatus: { color: "#1E90FF", fontSize: 13, fontWeight: 950, textTransform: "uppercase", letterSpacing: ".08em", marginBottom: 10 },
