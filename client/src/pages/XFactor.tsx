...
import { Activity, ArrowUp, Award, BarChart2, Bell, Bookmark, ChevronRight, Clock, Eye, Filter, Flame, Hash, Heart, Home, MapPin, MessageCircle, MoreHorizontal, Play, Plus, Repeat2, Search, Send, Share2, Smile, Star, Target, TrendingUp, Trophy, User, Users, Verified, Video, Zap, ImageIcon } from "lucide-react";
...
function XFactorScore({ score }: { score: number }) {
  const color = score >= 90 ? "text-blue-300" : score >= 80 ? "text-blue-400" : "text-slate-400";
  return (
        ...
        <div className="flex-1 min-w-0">
          ...
          {post.highlight && (
            <div className="mb-2 inline-flex items-center gap-1.5 bg-blue-950/60 border border-blue-800/50 rounded-full px-3 py-1">
              ...
              {post.trending && <Flame className="w-3 h-3 text-blue-400" />}
            </div>
          )}
              ...
              {TRENDING_ATHLETES.map((athlete, i) => (
                <div key={i} className="flex items-center gap-2 cursor-pointer hover:bg-slate-800 rounded-lg p-1.5 transition-colors">
                  ...
                  <div className="text-right flex-shrink-0">
                    <div className="text-xs font-bold text-blue-300 flex items-center gap-0.5">
        ...
        <div className="hidden xl:block w-72 flex-shrink-0 sticky top-[105px] h-[calc(100vh-105px)] overflow-y-auto px-4 py-4">
          ...
          <div className="bg-gradient-to-br from-blue-950 to-slate-900 border border-blue-800/50 rounded-2xl p-4 mb-4">
            ...
            <div className="space-y-1.5">
              {[
                { label: "90–100", desc: "Elite — Pro Prospect", color: "text-blue-300" },
