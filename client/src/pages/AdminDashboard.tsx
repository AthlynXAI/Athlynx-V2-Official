...
function AdminDashboardInner() {
  ...
  const seedFeedMutation = trpc.admin.seedFeed.useMutation();
              ...
              <Card className="bg-[#0d2847] border-cyan-500/20">
                ...
                <CardContent className="space-y-2">
                  ...
                  <Button 
                    ...
                    disabled={seedFeedMutation.isPending}
                    onClick={() => seedFeedMutation.mutate()}
                  >
                    <Activity className="h-4 w-4 mr-2" />
                    {seedFeedMutation.isPending ? "Seeding Feed..." : seedFeedMutation.isSuccess ? "Feed Seeded ✓" : "Seed Feed Data"}
                  </Button>
                </CardContent>
              </Card>
            </div>
  ...
  return (
    <div className="space-y-6">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${
                    member.connected
                      ...
                      : "bg-blue-900/30/40 text-blue-300 border border-blue-400/40/40"
                  }`}>
      ...
      <div className="bg-gradient-to-r from-green-950/40 to-slate-900/60 border border-green-800/30 rounded-2xl p-6">
        ...
        {connectedCount === 0 && (
          <p className="text-blue-300 text-xs mt-2">⚠️ No team members connected yet. Send onboarding links above first.</p>
        )}
              ...
              <div key={i} className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-bold ${
                    ...
                    r.status === "not_connected" ? "bg-blue-900/30/40 text-blue-300" :
...
function ExpiryWarningsPanel() {
  ...
  function daysColor(days: number) {
    ...
    if (days <= 4) return "text-blue-300";
