...
import { Shield, UserCheck, FileCheck, Lock, ClipboardCheck, ArrowRight, Trophy } from "lucide-react";
          ...
          <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <Card className="border-cyan-400/20 bg-cyan-400/[0.06]">
              <CardContent className="p-6 md:p-8">
                ...
                <div className={`mt-5 rounded-xl border px-4 py-3 text-sm font-bold ${requiredConsentComplete ? "border-cyan-400/40 bg-cyan-400/10 text-cyan-100" : "border-blue-500/40/40 bg-blue-900/40/10 text-blue-400"}`}>
