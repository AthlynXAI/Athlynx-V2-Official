/**
 * CheerElite — Canonical Less-Is-More sport page (Cheer)
 *
 * Generated from the DiamondGrind canonical template (Lane 4, 2026-05-19).
 * Hero: single H1 "The Cheer Playbook." · ONE CTA · corner BETA chip · full-bleed athlete media.
 *
 * Spec lock: docs/specs/SPORT_PAGE_DESIGN_SPEC.md
 * X-theme: black canvas, accent #EC4899, NO gold/yellow/amber.
...
// =====================================================================
// SPORT TOKEN — CheerElite (Cheer)
// =====================================================================
const SPORT = {
  name: "Cheer",
  pageTitle: "Cheer Elite",
  accent: "#EC4899",
...
const DISCIPLINES = ["Tumbling", "Stunts", "Jumps"] as const;
type Discipline = (typeof DISCIPLINES)[number];

const PILLARS_BY_DISCIPLINE: Record<Discipline, { name: string; sample: number; pro: number; ncaa: number }[]> = {
  "Tumbling": [
    { name: "Setup", sample: 82, pro: 80, ncaa: 70 },
    { name: "Rotation", sample: 75, pro: 78, ncaa: 68 },
    { name: "Landing", sample: 78, pro: 79, ncaa: 70 },
    { name: "Power", sample: 76, pro: 79, ncaa: 70 },
  ],
  "Stunts": [
    { name: "Base", sample: 78, pro: 80, ncaa: 70 },
    { name: "Top", sample: 81, pro: 82, ncaa: 71 },
    { name: "Sync", sample: 79, pro: 81, ncaa: 71 },
    { name: "Dismount", sample: 76, pro: 80, ncaa: 70 },
  ],
  "Jumps": [
    { name: "Height", sample: 80, pro: 81, ncaa: 70 },
    { name: "Form", sample: 73, pro: 79, ncaa: 68 },
    { name: "Snap", sample: 78, pro: 80, ncaa: 71 },
    { name: "Landing", sample: 76, pro: 80, ncaa: 70 },
  ],
};
...
const STATS_FIELDS = [
  { label: "Standing Tumbling", key: "standingTumbling", placeholder: "Full", group: "Tumbling" },
  { label: "Running Tumbling", key: "runningTumbling", placeholder: "Double Full", group: "Tumbling" },
  { label: "Best Pass", key: "bestPass", placeholder: "Standing Tuck", group: "Tumbling" },
  { label: "Position", key: "stuntPosition", placeholder: "Flyer / Base", group: "Stunts" },
  { label: "Best Stunt", key: "bestStunt", placeholder: "Liberty Full Down", group: "Stunts" },
  { label: "Years Exp.", key: "yearsExperience", placeholder: "6", group: "Stunts" },
  { label: "Toe Touch (in)", key: "toeTouchHeight", placeholder: "32", group: "Jumps" },
  { label: "Pike (in)", key: "pikeHeight", placeholder: "30", group: "Jumps" },
  { label: "Hurdler (in)", key: "hurdlerHeight", placeholder: "28", group: "Jumps" },
  { label: "Vertical (in)", key: "vertical", placeholder: "24", group: "Physical" },
  { label: "Flexibility", key: "flexibility", placeholder: "Pro", group: "Physical" },
];

const STATS_GROUPS = ["Tumbling", "Stunts", "Jumps", "Physical"];

const PROGRAMS = [
  { title: "Elite Tumbling Skills", level: "Elite", duration: "8 weeks", sessions: 24, desc: "Standing fulls, doubles — clean technique." },
  { title: "Stunt Progression", level: "Intermediate", duration: "6 weeks", sessions: 18, desc: "Liberty → full-down → bow & arrow." },
  { title: "Jump Power", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Height, snap, sharpness." },
  { title: "Flexibility & Injury Prev.", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Mobility, recovery, joint health." },
  { title: "Mental Performance", level: "All Levels", duration: "Ongoing", sessions: null, desc: "Routine confidence, big-stage focus." },
  { title: "College Tryout Prep", level: "Elite", duration: "3 weeks", sessions: 9, desc: "Cheerleading scholarship · D1 routines." },
];
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-5">
                ...
                <div className="grid grid-cols-2 gap-1.5 mb-3">
                  {[
    "4-week tumbling program",
    "Improve toe-touch height",
