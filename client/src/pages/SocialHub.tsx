          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-blue-400">{selectedPlatforms.length}</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <Card className="bg-gradient-to-br from-blue/20 to-red-600/10 border-blue/30">
                <CardContent className="pt-6 text-center">
                  <TrendingUp className="w-8 h-8 text-blue-400 mx-auto mb-2" />
                  <p className="text-2xl font-bold text-white">15B+</p>
                  <p className="text-blue-400 text-xs">Total Reach</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <Card className="bg-[#1a365d]/50 border-blue/30">
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-blue to-red-600 hover:from-blue/90 hover:to-red-600/90 text-black font-bold py-6 text-lg"
                >
                  {sending ? (
                    <>
            ...
            <Card className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border-cyan-500/30">
              <CardContent className="pt-6 text-center">
                <p className="text-blue-400 font-bold mb-2">FIRST MEDIA CONGLOMERATE</p>
