...
const USE_CASES = [
  ...
  { icon: "🏈", title: "On the Field", subtitle: "Real-Time Performance Partner", desc: "Tracks your movement patterns, speed, and positioning during practice. Feeds data directly into your AthlynX profile for coaches and recruiters to see.", sport: "Lacrosse", color: "from-red-900 to-red-800" },
  { icon: "⚾", title: "Baseball Diamond", subtitle: "Diamond Grind Robot", desc: "Pitching machine, fielding drill partner, and swing analyzer. Connects directly with Diamond Grind to log every session and track your development over time.", sport: "Softball", color: "from-red-900 to-red-800" },
  ...
  { icon: "🏊", title: "In the Pool", subtitle: "Aquatic Performance Tracker", desc: "Waterproof poolside companion that tracks lap times, stroke efficiency, and turn technique. Syncs directly with your AthlynX training log.", sport: "Water Polo", color: "from-cyan-900 to-cyan-800" },
      ...
      <div className="space-y-5 pb-20 lg:pb-6">
        ...
        <div className="relative bg-gradient-to-br from-[#0a1628] via-[#1a3a8f] to-[#0a1628] border border-blue-700 rounded-2xl overflow-hidden">
          ...
          <div className="relative p-6 text-center">
            ...
            <div className="text-blue-400 text-xs uppercase tracking-[0.3em] mb-1">Live</div>
