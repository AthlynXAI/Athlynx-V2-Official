...
import { FileText, Shield, AlertTriangle, CheckCircle, Star, MapPin, Calendar, ArrowRight, Award, Gavel, Lock, Globe, Users, DollarSign, Phone, Mail, BookOpen, Zap, Target, Search, Download, Trophy } from "lucide-react";
            ...
            {ATTORNEYS.map((atty, i) => (
              <div key={i} className={`bg-white/5 border rounded-2xl p-6 hover:bg-white/10 transition-all ${atty.featured ? "border-purple-400/40" : "border-white/10"}`}>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  ...
                  <div className="bg-white/5 rounded-lg p-2 text-center"><div className="text-xs font-black text-blue-300">Free</div><div className="text-xs text-slate-400">Consult</div></div>
                </div>
