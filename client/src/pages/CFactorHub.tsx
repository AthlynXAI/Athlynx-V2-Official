    ...
    <div className="flex flex-col items-center">
      ...
      <div className="text-center mt-2">
        ...
        <div className={`text-xs font-bold mt-1 px-2 py-0.5 rounded-full inline-block ${
          status === "available" ? "bg-[#00C2FF]/20 text-[#00C2FF]" :
          status === "committed" ? "bg-blue-500/20 text-blue-400" :
          status === "signed" ? "bg-[#1E90FF]/20 text-[#1E90FF]" :
          "bg-blue-500/20 text-[#00C2FF]"
        }`}>
  ...
  return (
    <Link href={href}>
      <div className={`relative flex flex-col items-center gap-2 p-4 rounded-2xl border cursor-pointer transition-all active:scale-95 hover:scale-[1.02] ${color}`}>
        {badge && (
          <span className="absolute -top-1.5 -right-1.5 text-[9px] font-black px-1.5 py-0.5 rounded-full bg-[#1E90FF] text-white">{badge}</span>
        )}
...
function LiveTicker() {
  ...
  return (
    <div className="bg-blue-900/40 border border-blue-800/50 rounded-xl px-4 py-2 flex items-center gap-3 overflow-hidden">
      <span className="text-[#1E90FF] text-xs font-black shrink-0 animate-pulse"> LIVE</span>
...
const ROLES = [
  { icon: "", label: "Athlete", desc: "Your career hub", href: "/athlete-dashboard", color: "from-blue-600 to-[#0a1628]" },
  { icon: "", label: "Agent", desc: "Client pipeline", href: "/crm-command", color: "from-[#1E90FF] to-blue-600" },
  { icon: "", label: "Coach", desc: "Team & recruiting", href: "/recruiting-hub", color: "from-[#00C2FF] to-teal-600" },
  { icon: "", label: "Lawyer", desc: "NIL compliance", href: "/athlete-legal-hub", color: "from-[#1E90FF] to-[#0a1628]" },
  { icon: "", label: "Brand", desc: "NIL marketplace", href: "/nil-portal", color: "from-[#1E90FF] to-[#0a1628]" },
  { icon: "", label: "Scout", desc: "Prospect database", href: "/rankings-hub", color: "from-blue-600 to-[#0a1628]" },
  { icon: "", label: "Family", desc: "Recruiting tracker", href: "/recruiting-hub", color: "from-[#1E90FF] to-blue-600" },
  { icon: "", label: "Media", desc: "Podcast & content", href: "/podcast", color: "from-[#1E90FF] to-[#0a1628]" },
];
...
const COMPARE = [
  ...
  { feature: "AI EPX Scoring", pg: false, hudl: false, on3: false, athlynx: true },
            ...
            <div className="flex items-center gap-2">
              <Link href="/notifications">
                <button className="relative p-2 rounded-xl bg-blue-900/40 border border-blue-800/50">
                  ...
                  <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#1E90FF] rounded-full text-[9px] font-black text-white flex items-center justify-center">3</span>
                </button>
              </Link>
              <Link href="/profile">
                <div
                  className="w-9 h-9 rounded-xl bg-slate-800 flex items-center justify-center text-slate-400 border-2 border-[#1E90FF]/30 overflow-hidden"
          ...
          <>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="space-y-2">
                    {[
                      { label: "Athletic Performance", val: Math.min(100, xScore + 8), color: "bg-[#1E90FF]" },
                      { label: "NIL Value", val: Math.min(100, xScore - 5), color: "bg-[#00C2FF]" },
                      { label: "Recruiting Profile", val: Math.min(100, xScore + 3), color: "bg-blue-500" },
                      { label: "Social Reach", val: Math.min(100, xScore - 12), color: "bg-[#1E90FF]" },
                    ].map(m => (
                      <div key={m.label}>
                  ...
                  <Link href="/epx">
                    <button className="w-full bg-gradient-to-r from-blue-600 to-[#0a1628] text-white text-xs font-black py-2 rounded-xl mt-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <QuickAction icon={<MessageCircle className="w-5 h-5" />} label="Messenger" href="/messenger" color="bg-[#00C2FF]/40 border-[#00C2FF]/50 hover:bg-[#00C2FF]/40" />
                <QuickAction icon={<Trophy className="w-5 h-5" />} label="Rankings" href="/rankings-hub" badge="NEW" color="bg-blue-900/40 border-blue-700/50 hover:bg-blue-800/40" />
                <QuickAction icon={<Mic className="w-5 h-5" />} label="Podcast" href="/podcast" color="bg-[#1E90FF]/40 border-[#1E90FF]/50 hover:bg-[#1E90FF]/40" />
                <QuickAction icon={<Video className="w-5 h-5" />} label="Film Room" href="/studio" color="bg-[#1E90FF]/40 border-[#1E90FF]/50 hover:bg-[#1E90FF]/40" />
                <QuickAction icon={<Target className="w-5 h-5" />} label="Recruiting" href="/recruiting-hub" color="bg-[#1E90FF]/20 border-[#1E90FF]/30 hover:bg-[#1E90FF]/20" />
                <QuickAction icon={<ShoppingBag className="w-5 h-5" />} label="Store" href="/athlete-store" color="bg-[#1E90FF]/20 border-[#1E90FF]/30 hover:bg-[#1E90FF]/20" />
                <QuickAction icon={<BarChart2 className="w-5 h-5" />} label="Analytics" href="/athlete-data" color="bg-[#1E90FF]/40 border-[#1E90FF]/50 hover:bg-[#1E90FF]/40" />
                ...
                <QuickAction icon={<Globe className="w-5 h-5" />} label="Transfer" href="/transfer-portal" color="bg-[#00C2FF]/40 border-[#00C2FF]/50 hover:bg-[#00C2FF]/40" />
                <QuickAction icon={<Award className="w-5 h-5" />} label="NIL Vault" href="/nil-vault" color="bg-[#1E90FF]/40 border-[#1E90FF]/50 hover:bg-[#1E90FF]/40" />
            ...
            <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl p-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { time: "7:00 PM", event: "The Athlete's Playbook Podcast", icon: "", type: "media" },
                ].map((item, i) => (
                  <div key={i} className="flex items-center gap-3 py-2 border-b border-blue-900/30 last:border-0">
                    ...
                    <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-full ${
                      item.type === "nil" ? "bg-[#00C2FF]/20 text-[#00C2FF]" :
                      item.type === "recruiting" ? "bg-blue-500/20 text-blue-400" :
                      item.type === "film" ? "bg-[#1E90FF]/20 text-[#1E90FF]" :
                      item.type === "media" ? "bg-[#1E90FF]/20 text-[#1E90FF]" :
                      "bg-[#1E90FF]/20 text-[#00C2FF]"
            ...
            <div className="bg-gradient-to-br from-[#00C2FF]/30 to-emerald-900/20 border border-[#00C2FF]/40 rounded-2xl p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="text-xs font-black text-[#00C2FF] tracking-widest uppercase"> NIL Opportunities</div>
                <Link href="/nil-portal"><span className="text-xs text-[#00C2FF] hover:text-[#00C2FF]">View All →</span></Link>
              </div>
              <div className="space-y-2">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 bg-[#00C2FF]/20 rounded-xl p-3">
                    <div className="text-2xl">{deal.logo}</div>
                    <div className="flex-1">
                      <div className="text-white text-xs font-bold">{deal.brand}</div>
                      <div className="text-[#00C2FF] text-[10px]">{deal.type} · {deal.value}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-[#00C2FF] text-xs font-black">{deal.match}%</div>
                      <div className="text-[#00C2FF] text-[9px]">match</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl p-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  { label: "Coach Views", value: "12", sub: "This week", icon: "", color: "text-[#00C2FF]" },
                  { label: "Scholarship Offers", value: "3", sub: "Pending review", icon: "", color: "text-[#00C2FF]" },
                  { label: "School Interests", value: "8", sub: "D1 programs", icon: "", color: "text-blue-400" },
                  { label: "Profile Views", value: "247", sub: "Last 30 days", icon: "", color: "text-[#1E90FF]" },
                ].map((stat, i) => (
            ...
            <div className="bg-gradient-to-br from-[#1E90FF]/30 to-[#0a1628]/20 border border-[#1E90FF]/40 rounded-2xl p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-xl bg-[#1E90FF] flex items-center justify-center">
                  <Mic className="w-6 h-6 text-white" />
                </div>
                <div>
                  <div className="text-xs font-black text-[#1E90FF] tracking-widest uppercase">Latest Episode</div>
                  <div className="text-white font-black text-sm">The Athlete's Playbook Podcast</div>
                </div>
              </div>
              <div className="bg-[#1E90FF]/20 rounded-xl p-3 mb-3">
                <div className="text-white text-sm font-bold mb-1">"NIL in 2026: Every Athlete Gets Paid"</div>
                <div className="text-[#1E90FF] text-xs">Chad A. Dozier · 42 min · 12.4K plays</div>
              </div>
              <div className="flex gap-2">
                <Link href="/podcast" className="flex-1">
                  <button className="w-full bg-[#1E90FF] hover:bg-[#1E90FF] text-white text-xs font-black py-2.5 rounded-xl flex items-center justify-center gap-2">
                    <Play className="w-4 h-4" /> Listen Now
                  </button>
                </Link>
                <Link href="/podcast">
                  <button className="bg-[#1E90FF]/40 border border-[#1E90FF]/50 text-[#1E90FF] text-xs font-bold px-4 py-2.5 rounded-xl">
                    All Episodes
                  </button>
                </Link>
              </div>
            ...
            <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl p-4">
              <div className="flex items-center justify-between mb-1">
                <div className="text-xs font-black text-blue-400 tracking-widest uppercase"> Vendor Marketplace</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { name: "Outdoor Performance", tagline: "Hunting & field gear", category: "Example Category", icon: "", color: "from-[#00C2FF]/40 to-teal-900/30", border: "border-[#00C2FF]/40", story: "Premium performance gear for athletes who train and compete in the field." },
                  { name: "Outdoor Lifestyle", tagline: "Adventure apparel", category: "Example Category", icon: "", color: "from-[#1E90FF]/20 to-blue-900/20", border: "border-[#1E90FF]/30", story: "Authentic outdoor lifestyle brands built for athletes who live the adventure." },
                  { name: "Sports Nutrition", tagline: "Fuel your performance", category: "Example Category", icon: "", color: "from-blue-900/40 to-[#0a1628]/30", border: "border-blue-700/40", story: "Nutrition and recovery brands designed for elite athletic performance." },
                  { name: "Tech & Wearables", tagline: "Train smarter", category: "Example Category", icon: "", color: "from-[#1E90FF]/40 to-indigo-900/30", border: "border-[#1E90FF]/40", story: "Smart training technology that feeds data directly to your AthlynX dashboard." },
                ].map((vendor, i) => (
                  <Link key={i} href="/athlete-store">
                    <div className={`bg-gradient-to-br ${vendor.color} border ${vendor.border} rounded-xl p-3 cursor-pointer hover:scale-[1.02] transition-transform`}>
                      ...
                      <div className="text-[9px] font-black px-1.5 py-0.5 rounded-full bg-blue-500/20 text-[#00C2FF] inline-block mb-1">COMING SOON</div>
            ...
            <div className="bg-gradient-to-br from-[#0d1e3c] to-[#0a1628] border border-blue-800/50 rounded-2xl p-5 text-center">
              ...
              <div className="mt-4 grid grid-cols-3 gap-3 text-center">
                {[
                  ...
                  <div key={i} className="bg-blue-900/30 rounded-xl p-3">
                    <div className="text-[#00C2FF] font-black text-xl">{s.val}</div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl overflow-hidden">
              <div className="grid grid-cols-5 bg-blue-900/40 px-3 py-2 text-[10px] font-black text-blue-400 uppercase tracking-wider">
                ...
                <div className="text-center text-[#00C2FF]">AthlynX</div>
              </div>
              {COMPARE.map((row, i) => (
                <div key={i} className={`grid grid-cols-5 px-3 py-2.5 border-t border-blue-900/30 ${i % 2 === 0 ? "bg-blue-900/10" : ""}`}>
                  ...
                  <div className="flex justify-center">{row.pg ? <span className="text-[#00C2FF] text-sm"></span> : <span className="text-[#1E90FF]/50 text-sm"></span>}</div>
                  <div className="flex justify-center">{row.hudl ? <span className="text-[#00C2FF] text-sm"></span> : <span className="text-[#1E90FF]/50 text-sm"></span>}</div>
                  <div className="flex justify-center">{row.athlynx ? <span className="text-[#00C2FF] text-sm font-black"></span> : <span className="text-[#1E90FF]/50 text-sm"></span>}</div>
                </div>
              ))}
            </div>
            <div className="bg-gradient-to-br from-[#1E90FF]/20 to-blue-900/20 border border-[#1E90FF]/30 rounded-2xl p-4 text-center">
              <div className="text-[#00C2FF] font-black text-3xl mb-1">15/15</div>
        ...
        {activeSection === "ecosystem" && (
          <div className="space-y-4">
            ...
            {[
              ...
              {
                category: " Command Center (Desktop/Studio)",
              ...
              },
              {
                ...
                items: [
                  ...
                  { label: "EPX Scoring", href: "/epx", badge: "AI" },
                  ...
                  {section.items.map((item, j) => (
                    <Link key={j} href={item.href}>
                      <div className="flex items-center justify-between py-2 px-3 rounded-xl hover:bg-blue-900/30 transition-colors cursor-pointer">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-full ${
                            item.badge === "LIVE" ? "bg-[#00C2FF]/20 text-[#00C2FF]" :
                            item.badge === "NEW" ? "bg-blue-500/20 text-[#00C2FF]" :
                            item.badge === "AI" ? "bg-[#1E90FF]/20 text-[#1E90FF]" :
