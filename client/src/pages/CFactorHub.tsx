...
const ROLES = [
  ...
  { icon: "⚖️", label: "Lawyer", desc: "NIL compliance", href: "/athlete-legal-hub", color: "from-cyan-600 to-red-600" },
  { icon: "🏷️", label: "Brand", desc: "NIL marketplace", href: "/nil-portal", color: "from-pink-600 to-rose-600" },
  { icon: "🔍", label: "Scout", desc: "Prospect database", href: "/rankings-hub", color: "from-blue-600 to-cyan-600" },
          ...
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <QuickAction icon={<ShoppingBag className="w-5 h-5" />} label="Store" href="/athlete-store" color="bg-cyan-900/40 border-cyan-700/50 hover:bg-cyan-800/40" />
            ...
            <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { name: "Outdoor Lifestyle", tagline: "Adventure apparel", category: "Example Category", icon: "🎒", color: "from-cyan-900/30 to-blue-900/20", border: "border-cyan-700/40", story: "Authentic outdoor lifestyle brands built for athletes who live the adventure." },
                  ...
                  <Link key={i} href="/athlete-store">
                    <div className={`bg-gradient-to-br ${vendor.color} border ${vendor.border} rounded-xl p-3 cursor-pointer hover:scale-[1.02] transition-transform`}>
                      ...
                      <div className="text-[9px] font-black px-1.5 py-0.5 rounded-full bg-blue-500/20 text-sky-400 inline-block mb-1">COMING SOON</div>
                      ...
                      <div className="flex items-center justify-between py-2 px-3 rounded-xl hover:bg-blue-900/30 transition-colors cursor-pointer">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-full ${
                            ...
                            item.badge === "NEW" ? "bg-blue-500/20 text-sky-400" :
