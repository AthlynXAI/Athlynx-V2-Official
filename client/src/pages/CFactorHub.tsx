...
import {
  ...
  Calendar, BookOpen, Briefcase, Gavel, Heart,
...
function CFactorRing({ score, name, sport, position, school, status }: {
  ...
  const color = score >= 90 ? "#00ff88" : score >= 75 ? "#00c2ff" : score >= 60 ? "#1E90FF" : "#ef4444";
...
const ROLES = [
  ...
  { icon: "⚖️", label: "Lawyer", desc: "NIL compliance", href: "/athlete-legal-hub", color: "from-blue-600 to-red-600" },
  { icon: "🏷️", label: "Brand", desc: "NIL marketplace", href: "/nil-portal", color: "from-pink-600 to-rose-600" },
  { icon: "🔍", label: "Scout", desc: "Prospect database", href: "/rankings-hub", color: "from-blue-500 to-blue-600" },
          ...
          <>
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <QuickAction icon={<Trophy className="w-5 h-5" />} label="Rankings" href="/rankings-hub" badge="NEW" color="bg-blue-900/30/40 border-blue-400/40/50 hover:bg-blue-900/30/40" />
                ...
                <QuickAction icon={<ShoppingBag className="w-5 h-5" />} label="Store" href="/athlete-store" color="bg-blue-900/40 border-blue-700/50 hover:bg-blue-800/40" />
            ...
            <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { name: "Outdoor Lifestyle", tagline: "Adventure apparel", category: "Example Category", icon: "🎒", color: "from-blue-900/30 to-blue-300/20", border: "border-blue-700/40", story: "Authentic outdoor lifestyle brands built for athletes who live the adventure." },
                  ...
                  <Link key={i} href="/athlete-store">
                    <div className={`bg-gradient-to-br ${vendor.color} border ${vendor.border} rounded-xl p-3 cursor-pointer hover:scale-[1.02] transition-transform`}>
                      ...
                      <div className="text-[9px] font-black px-1.5 py-0.5 rounded-full bg-blue-900/30/20 text-blue-300 inline-block mb-1">LIVE BETA</div>
                      ...
                      <div className="flex items-center justify-between py-2 px-3 rounded-xl hover:bg-blue-900/30 transition-colors cursor-pointer">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-full ${
                            ...
                            item.badge === "NEW" ? "bg-blue-900/30/20 text-blue-300" :
