    ...
    <div className="min-h-screen bg-gradient-to-br from-[#040c1a] via-[#0a1628] to-[#040c1a] text-white flex flex-col items-center justify-center p-8">
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <Link href="/signup" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-black px-8 py-4 rounded-xl text-base shadow-xl transition-all hover:scale-105">
              Join Free — 7 Day Trial
            </Link>
          <Link href="/portal" className="bg-[#1a3a8f] hover:bg-[#1530a0] text-white font-bold px-8 py-4 rounded-xl text-base border border-blue-700/50 transition-all">
              Explore Platform
            </Link>
        </div>
...
export default function ComingSoon({ title = "Live", description = "This feature is launching soon. Stay tuned!", icon = "🚀" }: Partial<ComingSoonProps>) {
