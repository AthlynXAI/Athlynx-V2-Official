/**
 * FieldHockeyElite — Canonical Less-Is-More sport page (Field Hockey)
 *
 * Generated from the DiamondGrind canonical template (Lane 4, 2026-05-19).
 * Hero: single H1 "The Field Hockey Playbook." · ONE CTA · corner BETA chip · full-bleed athlete media.
 *
 * Spec lock: docs/specs/SPORT_PAGE_DESIGN_SPEC.md
 * X-theme: black canvas, accent #0D9488, NO gold/yellow/amber.
...
// =====================================================================
// SPORT TOKEN — FieldHockeyElite (Field Hockey)
// =====================================================================
const SPORT = {
  name: "Field Hockey",
  pageTitle: "Field Hockey Elite",
  accent: "#0D9488",
  accentSoft: "rgba(13,148,136,0.12)",
  accentRing: "rgba(13,148,136,0.40)",
  emblem: "",
  trpcSport: "Field Hockey",
  ctaLabel: "Get Assessed",
  heroPhoto: "/sport-hero/field-hockey-hero.jpg",
  heroPhotoFallback: "/og-image.png",
  closingTagline: "90 MINUTES. ONE SCORE. FOREVER CHANGED.",
};

const DISCIPLINES = ["Attacking", "Defending", "Goalkeeping"] as const;
type Discipline = (typeof DISCIPLINES)[number];

const PILLARS_BY_DISCIPLINE: Record<Discipline, { name: string; sample: number; pro: number; ncaa: number }[]> = {
  "Attacking": [
    { name: "Drag Flick", sample: 82, pro: 80, ncaa: 70 },
    { name: "Reception", sample: 75, pro: 78, ncaa: 68 },
    { name: "1v1", sample: 78, pro: 79, ncaa: 70 },
    { name: "Finishing", sample: 76, pro: 79, ncaa: 70 },
  ],
  "Defending": [
    { name: "Tackle", sample: 78, pro: 80, ncaa: 70 },
    { name: "Positioning", sample: 81, pro: 82, ncaa: 71 },
    { name: "Aerial", sample: 79, pro: 81, ncaa: 71 },
    { name: "Recovery", sample: 76, pro: 80, ncaa: 70 },
  ],
  "Goalkeeping": [
    { name: "Set", sample: 80, pro: 81, ncaa: 70 },
    { name: "Save", sample: 73, pro: 79, ncaa: 68 },
    { name: "Clear", sample: 78, pro: 80, ncaa: 71 },
    { name: "Penalty", sample: 76, pro: 80, ncaa: 70 },
  ],
};
...
const STATS_FIELDS = [
  { label: "Goals", key: "goals", placeholder: "14", group: "Attacking" },
  { label: "Assists", key: "assists", placeholder: "9", group: "Attacking" },
  { label: "Shots / Game", key: "shotsPerGame", placeholder: "3.4", group: "Attacking" },
  { label: "Drag Flick %", key: "dragFlickPct", placeholder: "62", group: "Attacking" },
  { label: "Tackles", key: "tackles", placeholder: "42", group: "Defending" },
  { label: "Interceptions", key: "interceptions", placeholder: "28", group: "Defending" },
  { label: "Position", key: "position", placeholder: "CB / SW", group: "Defending" },
  { label: "Save %", key: "savePct", placeholder: "78", group: "Goalkeeping" },
  { label: "Clean Sheets", key: "cleanSheets", placeholder: "9", group: "Goalkeeping" },
  { label: "Sprint (mph)", key: "sprintSpeed", placeholder: "18", group: "Physical" },
  { label: "Beep Test", key: "beepTest", placeholder: "L13", group: "Physical" },
];

const STATS_GROUPS = ["Attacking", "Defending", "Goalkeeping", "Physical"];

const PROGRAMS = [
  { title: "Elite Drag Flick Mechanics", level: "Elite", duration: "8 weeks", sessions: 24, desc: "Penalty corners, power, accuracy." },
  { title: "Attacking Footwork", level: "Intermediate", duration: "6 weeks", sessions: 18, desc: "1v1, reception, finishing." },
  { title: "Defending Fundamentals", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Tackle, positioning, aerial." },
  { title: "Goalkeeping Reactions", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Set, save, clear — penalty corner specialist." },
  { title: "Mental Performance", level: "All Levels", duration: "Ongoing", sessions: null, desc: "Match focus, pressure rehearsal." },
  { title: "College Recruit Prep", level: "Elite", duration: "3 weeks", sessions: 9, desc: "USA Field Hockey · D1 scholarship-ready." },
];
...
function FieldHockeyEliteInner() {
  const { user } = useAuth();
