      ...
      <div className="max-w-5xl mx-auto px-2 py-4 space-y-5 pb-24">
        ...
        <div className="bg-gradient-to-r from-[#0a1628] to-[#1a3a8f] border border-red-700/40 rounded-2xl p-6">
          ...
          <div className="mt-4 bg-[#0d1b3e] border border-blue-800 rounded-xl p-4 flex items-center gap-4">
            <Crown className="w-8 h-8 text-sky-400 shrink-0" />
            <div>
              <div className="text-sky-400 text-xs font-black uppercase tracking-wider">Master Admin — Human Identity Verified</div>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <span className="bg-blue-500/20 border border-blue-500/30 text-sky-400 text-[10px] font-black px-2 py-1 rounded-full">⚖️ {IP_ASSETS.length} IP Assets Documented</span>
        ...
        {activeTab === "agents" && (
          <div className="space-y-4">
            <div className="bg-blue-900/20 border border-blue-700/40 rounded-xl p-3 text-xs text-sky-300">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-full ${agent.securityLevel === "HIGH" ? "bg-red-700 text-white" : "bg-blue-700 text-white"}`}>{agent.securityLevel}</span>
                        </div>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div className="bg-[#060d1f] border border-blue-900/30 rounded-xl p-3">
                        <div className="flex items-center gap-1 mb-1"><Key className="w-3 h-3 text-sky-400" /><span className="text-sky-400 text-[10px] font-black uppercase">IP Owner</span></div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      ...
                      <span className={`text-[9px] font-black px-2 py-0.5 rounded-full ${conn.status === "active" ? "bg-green-700 text-white" : "bg-blue-700 text-white"}`}>{conn.status.toUpperCase()}</span>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-blue-950/40 to-[#0d1b3e] border border-blue-700/40 rounded-2xl p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <div className="text-sky-400 text-xs font-black uppercase tracking-wider">Legal IP Declaration</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      ...
                      <span className="text-[10px] bg-blue-900/30 text-sky-400 px-2 py-0.5 rounded-full border border-blue-800/30">{asset.owner}</span>
                    </div>
        ...
        {activeTab === "security" && (
          <div className="space-y-4">
            ...
            {SECURITY_RULES.map((rule, i) => (
              <div key={i} className={`bg-[#0d1b3e] border rounded-xl p-4 ${rule.severity === "CRITICAL" ? "border-red-700/50" : "border-blue-700/40"}`}>
                <div className="flex items-start gap-3">
                  <AlertTriangle className={`w-5 h-5 shrink-0 mt-0.5 ${rule.severity === "CRITICAL" ? "text-red-400" : "text-sky-400"}`} />
                  <div>
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      <span className="text-white font-black text-sm">{rule.rule}</span>
                      <span className={`text-[9px] font-black px-2 py-0.5 rounded-full ${rule.severity === "CRITICAL" ? "bg-red-700 text-white" : "bg-blue-700 text-white"}`}>{rule.severity}</span>
                    </div>
