          ...
          <div className="bg-[#0a1628] border border-[#1E90FF]/25 rounded-t-2xl sm:rounded-2xl w-full max-w-sm p-5 space-y-4 overflow-y-auto" style={{maxHeight: "85vh", paddingBottom: "80px"}}>
            ...
            <div className="flex gap-3">
              <button onClick={() => createStory.mutate({ caption: newStory.caption, storyType: newStory.storyType as any, mediaType: "text" })}
                ...
                className="flex-1 bg-gradient-to-r from-[#1E90FF] via-[#0080FF] to-[#1E90FF] hover:from-white hover:via-cyan-200 hover:to-amber-200 text-slate-950 shadow-[0_12px_38px_rgba(30,144,255,0.28)] disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-colors">
  ...
  return (
    <PlatformLayout>
      <div className="space-y-3 pb-24 lg:pb-4">
        ...
        <section className="relative overflow-hidden rounded-[28px] border border-amber-300/25 bg-[radial-gradient(circle_at_10%_0%,rgba(251,191,36,0.22),transparent_34%),radial-gradient(circle_at_90%_10%,rgba(30,144,255,0.20),transparent_32%),linear-gradient(135deg,rgba(3,7,18,0.98),rgba(8,13,30,0.94)_45%,rgba(15,23,42,0.98))] p-4 shadow-[0_30px_90px_rgba(0,0,0,0.6)]">
          <div className="absolute -right-12 -top-16 h-40 w-40 rounded-full bg-[#1E90FF]/20 blur-3xl" />
          <div className="absolute -left-10 bottom-0 h-32 w-32 rounded-full bg-amber-300/15 blur-3xl" />
          <div className="relative flex items-start justify-between gap-3">
            <div>
              <div className="text-[10px] font-black uppercase tracking-[0.32em] text-amber-200">AthlynX COMMAND FEED</div>
        ...
        <div className="bg-[#000000]/92 border border-[#1E90FF]/20 rounded-2xl shadow-[0_24px_60px_rgba(0,0,0,0.42)] backdrop-blur-xl overflow-hidden">
          {user ? (
            <>
              ...
              <div className="flex items-center gap-1 px-4 pb-3 pt-1 border-t border-[#1E90FF]/15/50">
                ...
                <button onClick={() => postText.trim() && createPostMutation.mutate({ content: postText, postType })}
                  ...
                  className="ml-auto bg-gradient-to-r from-[#1E90FF] via-[#0080FF] to-[#1E90FF] hover:from-white hover:via-cyan-200 hover:to-amber-200 text-slate-950 shadow-[0_12px_38px_rgba(30,144,255,0.28)] disabled:opacity-50 text-white text-sm font-bold px-5 py-1.5 rounded-full transition-colors">
            ...
            <div className="p-4 text-center">
              <a href="/signup" className="inline-block bg-gradient-to-r from-[#1E90FF] via-[#0080FF] to-[#1E90FF] hover:from-white hover:via-cyan-200 hover:to-amber-200 text-slate-950 shadow-[0_12px_38px_rgba(30,144,255,0.28)] text-white font-bold px-6 py-2.5 rounded-xl transition-colors">Sign In to Post</a>
            </div>
          )}
        </div>
            ...
            {[
              ...
              <div key={i} className="bg-[#000000]/92 border border-[#1E90FF]/20 rounded-2xl shadow-[0_24px_60px_rgba(0,0,0,0.42)] backdrop-blur-xl overflow-hidden">
                <div className="flex items-start gap-3 p-4 pb-2">
                  ...
                  <span className={`text-[9px] font-black px-2 py-1 rounded-full text-white ${p.type === 'NIL_DEAL' ? 'bg-purple-600' : p.type === 'ACHIEVEMENT' ? 'bg-yellow-600' : p.type === 'WORKOUT' ? 'bg-green-600' : 'bg-[#1E90FF]'}`}>{p.type.replace('_', ' ')}</span>
                </div>
