  ...
  return (
    <PlatformLayout>
      <div className="space-y-3 pb-24 lg:pb-4">
        ...
        <section className="relative overflow-hidden rounded-[28px] border border-blue-300/25 bg-[radial-gradient(circle_at_10%_0%,rgba(251,191,36,0.22),transparent_34%),radial-gradient(circle_at_90%_10%,rgba(30,144,255,0.20),transparent_32%),linear-gradient(135deg,rgba(3,7,18,0.98),rgba(8,13,30,0.94)_45%,rgba(15,23,42,0.98))] p-4 shadow-[0_30px_90px_rgba(0,0,0,0.6)]">
