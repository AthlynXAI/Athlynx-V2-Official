...
const regionals = [
  ...
  },
  {
    ...
    "hostSite": "Mac Nease Baseball Park at Russ Chandler Atlanta, Georgia",
    "teams": [
      "No. 1 Georgia Tech",
      "No. 2 Oklahoma",
      "No. 3 The Citadel",
  ...
  },
  {
    ...
    "hostSite": "UFCU Disch-Falk Austin, Texas",
    "teams": [
      "No. 1 Texas",
  ...
  },
  {
    ...
    "hostSite": "Boshamer Chapel Hill, North Carolina",
    "teams": [
      "No. 1 North Carolina",
      "No. 2 Tennessee",
      "No. 3 East Carolina",
  ...
  },
  {
    ...
    "hostSite": "Pete Taylor Park/Hill Denson Hattiesburg, Mississippi",
    "teams": [
      "No. 1 Southern Miss",
      "No. 2 Virginia",
  ...
  },
  {
    ...
    "hostSite": "Jackie Robinson Los Angeles, California",
    "teams": [
      "No. 1 UCLA",
  ...
  },
  {
    ...
    "hostSite": "Dudy Noble Starkville, Mississippi",
    "teams": [
  ...
  },
  {
    ...
    "hostSite": "Mike Martin Field at Dick Howser Tallahassee, Florida",
    "teams": [
      "No. 1 Florida St.",
  ...
  },
  {
    ...
    "hostSite": "Sewell-Thomas Tuscaloosa, Alabama",
    "teams": [
      "No. 1 Alabama",
      "No. 2 Oklahoma State",
      "No. 3 USC Upstate",
      ...
      <main className="relative min-h-screen overflow-hidden bg-[#020617] text-white">
        ...
        <section className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-wrap items-center gap-3">
            ...
            <span className="rounded-full border border-blue-400/40/30 bg-blue-900/30/10 px-4 py-2 text-xs font-black uppercase tracking-[0.25em] text-blue-300">
              Road to Omaha 2026
            </span>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-5">
                  <div className="text-3xl font-black text-blue-300">{regionals.length}</div>
            ...
            <div className="athlynx-premium-watermark-card rounded-[2rem] border border-white/10 p-6 shadow-2xl backdrop-blur">
              <p className="text-xs font-black uppercase tracking-[0.25em] text-blue-300">Mississippi watch · MSU loyalty</p>
              ...
              <article key={regional.regional} className="rounded-[1.5rem] border border-white/10 bg-white/[0.045] p-5 shadow-xl backdrop-blur transition hover:border-blue-300/40 hover:bg-white/[0.07]">
                ...
                <div className="mt-5 grid gap-5 md:grid-cols-[0.85fr_1.15fr]">
                  ...
                  <div className="space-y-4">
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-300">Opening matchups</p>
