...
import { Play, Pause, SkipForward, SkipBack, Volume2, Clock, Mic, Headphones, ExternalLink, ChevronRight, Share2, Download, Star } from 'lucide-react';
...
const SHOW_INFO = {
  ...
  hostTitle: "Founder-led media lane — AthlynXAI OS, AXN, Suno, and live-data workflows",
...
const PLATFORMS = [
  ...
  { name: "Pocket Casts", icon: "🎙️", url: "https://pocketcasts.com", color: "from-blue-600 to-blue-800" },
...
const EPISODES = [
  ...
  },
  {
    ...
    description: "Your brand is your business. Learn how to build a social media presence that attracts NIL deals, connects with fans, and positions you for success beyond sports. TikTok, and the AthlynX Feed.",
    duration: "39:45",
    date: "May 6, 2026",
    season: 1,
...
const PODCAST_MEDIA = [
  ...
  },
  {
    ...
    poster: "/media/podcast/athlynx-logo-lockup-black.png",
    description: "A polished Athlete’s Playbook Season 1 Episode 1 Video 3 reel built from the approved legacy source packet with no duplicate source use. Chad and Lee open the piece, Lee’s latest voice memo leads the audio, and the AthlynXAI OS v1 media lane connects Spotify for Creators, Suno, Vimeo, AXN, and AthlynXAI-owned proof.",
  },
  {
...
const CHAMPIONSHIP_VISUALS = [
  ...
  { src: "/media/championship-brand/episode-2/scene08-helmet-bag-hat-eyewear.png", title: "bag, hat, eyewear", lane: "Accessories · Brand wall · Retail" },
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 px-6 py-3 rounded-xl">
                  <Trophy className="w-5 h-5 mr-2" /> Subscribe
                </Button>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-[#061426] via-[#0b2a55] to-[#061426] border border-cyan-400/20 rounded-3xl p-6 md:p-8">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black mt-3 mb-4">AXN, Suno, live data, and Nebius H200 in one owned loop.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 leading-relaxed">
                On The Athlete's Playbook Chad brings real conversations with the people who 
