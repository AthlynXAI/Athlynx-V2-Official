...
const SOURCE_COLORS: Record<string, string> = {
  ...
  video_analysis: "border-blue-400/40 bg-blue-400/5 text-blue-400",
          ...
          <>
            ...
            <div>
              <h2 className="text-lg font-black text-white mb-3 flex items-center gap-2">
                ...
                {isDemo && <span className="text-blue-300/60 text-xs font-normal">(demo — start using the platform to see your real data)</span>}
              </h2>
              {myLoading ? (
