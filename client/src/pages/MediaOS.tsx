...
const lanes = [
  {
    ...
    rails: "Spotify for Creators, RSS, AXN clips, social cuts",
  },
  {
  ...
  },
  {
    ...
    rails: "LinkedIn, TikTok, YouTube, Buffer/Zapier fallback only",
  },
  {
...
const layers = [
  ...
  ["Queue", "pending review, approved, scheduled, posting, posted, failed, retrying, and manual-intervention states are visible."],
  ...
  ["Distribute", "Spotify for Creators, AXN, social networks, Buffer, and Zapier are rails. AthlynXAI OS remains the brain."],
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-blue-100 text-base sm:text-lg leading-relaxed">
                  The owned operating system for The Athlete’s Playbook Spotify for Creators, Suno music, AXN streaming, fail-proof social distribution, and the free-entry plus tiers/credits model. External platforms are rails. AthlynXAI OS is the source of truth.
                </p>
              </div>
