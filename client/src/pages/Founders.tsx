      ...
      <div className="space-y-4 pb-20 lg:pb-4">
        ...
        {TEAM.map((person) => (
          ...
          >
            ...
            {/* Contact Info — mailto/tel rows render only when access is
                active. Members on hold render the rest of their card
                identically (photo, bio, stats) with no public Suspended label,
                so the hold remains invisible. */}
            <div className="w-full space-y-2 max-w-sm">
              {!isSuspended(person.name) && (
                <>
