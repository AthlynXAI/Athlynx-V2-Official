...
const TECH_STACK = [
  ...
  { name: "Media & Content", category: "Platform Capability", role: "Video, profiles, highlights, stories, and brand-facing content workflows.", status: "LIVE", color: "from-blue-500 to-red-600", badge: "MEDIA" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-[#0d0d1a] to-[#1a0d2e] border border-purple-500/30 rounded-2xl p-10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <span className="inline-block bg-purple-500/20 border border-purple-500/40 text-purple-300 font-black px-8 py-3 rounded-xl text-sm tracking-widest">ACTIVE DISCUSSIONS</span>
            </div>
          </div>
        </div>
      </section>

      {/* Strategic Partnerships — Live */}
            ...
            {[
              ...
              <div key={item.category} className="bg-gradient-to-br from-[#0d1b3e] to-[#080d1a] border border-blue-900/60 hover:border-red-500/50 rounded-2xl p-6 transition-all group relative overflow-hidden">
                <div className="absolute top-3 right-3">
                  <span className="bg-red-500/20 border border-red-500/40 text-red-400 text-xs font-black px-2 py-1 rounded-lg">LIVE BETA</span>
                </div>
