...
const TECH_STACK = [
  ...
  { name: "Media & Content", category: "Platform Capability", role: "Video, profiles, highlights, stories, and brand-facing content workflows.", status: "LIVE", color: "from-cyan-500 to-red-600", badge: "MEDIA" },
