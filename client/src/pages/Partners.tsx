...
const TECH_STACK = [
  ...
  { name: "Recruiting Presence", category: "Athlete Growth", role: "Profiles, media, visibility, and coach-facing presentation built into one athlete journey.", status: "LIVE", color: "from-[#1E90FF] to-blue-700", badge: "GROW" },
  { name: "NIL Readiness", category: "Commerce", role: "Prepared for memberships, credits, brand opportunities, licensing, and partner programs.", status: "LIVE", color: "from-[#1E90FF] to-blue-700", badge: "NIL" },
  { name: "Transfer Pathway", category: "Athlete Growth", role: "Designed to help athletes improve visibility, compare opportunities, and move toward better fit.", status: "LIVE", color: "from-[#00C2FF] to-teal-600", badge: "PATH" },
  ...
  { name: "Media & Content", category: "Platform Capability", role: "Video, profiles, highlights, stories, and brand-facing content workflows.", status: "LIVE", color: "from-[#1E90FF] to-[#0a1628]", badge: "MEDIA" },
  { name: "Communication Layer", category: "Platform Capability", role: "Messaging, alerts, scheduling, and relationship workflows for platform users.", status: "LIVE", color: "from-[#1E90FF] to-[#0a1628]", badge: "COMM" },
...
const PARTNER_TIERS = [
  ...
  { name: "Gold", commission: "20%", requirements: "$25K/month revenue", benefits: ["Everything in Silver", "API access", "White-label options", "Priority features"], color: "from-[#1E90FF] to-[#0a1628]" },
  { name: "Platinum", commission: "25%", requirements: "$100K/month revenue", benefits: ["Everything in Gold", "Revenue share", "Board advisory", "Equity options"], color: "from-[#1E90FF] to-blue-500" },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#060e24] via-[#0d1b3e] to-[#060e24] text-white">
      ...
      <header className="bg-[#080d1a]/90 border-b border-blue-900 sticky top-0 z-50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/">
              <button className="bg-gradient-to-r from-blue-600 to-[#0a1628] text-white px-4 py-2 rounded-lg font-bold text-sm">
                ← Home
              </button>
            </Link>
          </div>
      ...
      <section className="py-20 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-[#1E90FF]/20 border border-[#1E90FF]/30 text-[#00C2FF] px-4 py-2 rounded-full text-sm font-black tracking-widest uppercase mb-6">
            <Handshake className="w-4 h-4" />
Partners & Platform Inquiry
          </div>
          <h1 className="text-5xl md:text-7xl font-black mb-6 text-white">
            REVOLUTIONARY<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E90FF] to-blue-500">AthlynXAI OS</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="mailto:contact@athlynx.ai" className="bg-gradient-to-r from-blue-600 to-[#0a1628] text-white px-8 py-4 rounded-xl font-black text-lg flex items-center gap-2 hover:scale-105 transition-transform">
          ...
          <div className="bg-gradient-to-r from-slate-800/80 to-gray-900/80 border-2 border-slate-500/50 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <span className="bg-[#00C2FF]/20 border border-[#00C2FF]/40 text-[#00C2FF] text-xs font-black px-3 py-1 rounded-full">PARTNER INQUIRY</span>
      ...
      <section className="py-8 px-4 bg-white/5 border-y border-blue-900">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div><div className="text-3xl font-black text-[#00C2FF]">Private</div><div className="text-blue-300 text-sm">Architecture</div></div>
          <div><div className="text-3xl font-black text-[#1E90FF]">$180M+</div><div className="text-blue-300 text-sm">Market Opportunity</div></div>
          <div><div className="text-3xl font-black text-[#00C2FF]">15+</div><div className="text-blue-300 text-sm">Sport Platforms</div></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {TECH_STACK.map((partner) => {
              ...
              return (
                <div key={partner.name} className="bg-white/5 border border-blue-900/50 hover:border-[#1E90FF]/30 rounded-2xl p-5 transition-all hover:bg-white/10 group">
                  ...
                  <div className="mt-3 flex items-center gap-1">
                    ...
                    <span className="text-[#00C2FF] text-xs font-bold">LIVE</span>
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {PARTNER_TIERS.map((tier) => (
              <div key={tier.name} className="bg-[#080d1a] rounded-2xl p-6 border border-blue-900 hover:border-[#1E90FF]/30 transition-all">
                ...
                <p className="text-4xl font-black text-[#00C2FF] mb-1">{tier.commission}</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-blue-900">
              <BarChart3 className="w-12 h-12 text-[#00C2FF] mb-4" />
              ...
              <Link href="/crm">
                <button className="bg-[#1565C0] hover:bg-[#1E90FF] text-white px-6 py-3 rounded-lg font-bold transition-colors">
                  Partner Dashboard
                </button>
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["athlynx.ai", "nilportals.com", "nilportal.ai", "transferportal.ai", "athlynx.ai", "athlynx.ai", "athlynx.ai", "athlynx.ai"].map((domain) => (
              <span key={domain} className="bg-gradient-to-r from-blue-600/30 to-[#0a1628]/30 border border-blue-500/40 text-[#00C2FF] px-4 py-2 rounded-lg font-bold text-sm">
                {domain}
              </span>
            ))}
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-[#0d0d1a] to-[#1a0d2e] border border-[#1E90FF]/30 rounded-2xl p-10 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(120,0,255,0.08)_0%,_transparent_70%)]" />
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 bg-[#1E90FF]/20 border border-[#1E90FF]/30 text-[#1E90FF] px-4 py-2 rounded-full text-sm font-black tracking-widest uppercase mb-6">
                 Robotics Division
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
                THE FUTURE IS<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E90FF] to-[#0a1628]">AUTONOMOUS</span>
              </h2>
              <p className="text-[#1E90FF]/70 text-lg max-w-2xl mx-auto mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {[
                  { icon: "", title: "Stadium Operations", desc: "Autonomous security, logistics, and fan experience robots" },
                  { icon: "", title: "Training Companions", desc: "AI-powered athletic training and performance bots" },
                  { icon: "", title: "Data Center Bots", desc: "Automated facility management and infrastructure ops" },
                ].map(item => (
                  <div key={item.title} className="bg-white/5 border border-[#1E90FF]/20 rounded-xl p-5">
                    <div className="text-3xl mb-3">{item.icon}</div>
                    <h4 className="text-white font-black mb-2">{item.title}</h4>
                    <p className="text-[#1E90FF]/60 text-sm">{item.desc}</p>
                  </div>
                ))}
              </div>
              <span className="inline-block bg-[#1E90FF]/20 border border-[#1E90FF]/40 text-[#1E90FF] font-black px-8 py-3 rounded-xl text-sm tracking-widest">COMING SOON — PARTNERSHIPS IN DISCUSSIONS</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-5xl font-black text-white mb-4">
              WELCOMING NEW<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E90FF] to-[#0a1628]">PARTNERSHIPS</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              ...
              { category: "Athletic Equipment", icon: "", desc: "Training equipment, performance tech, and recovery brands for elite athletes." },
              ...
              { category: "Data Center Infrastructure", icon: "", desc: "Co-location, power, cooling, and data center construction partnerships." },
              ...
              <div key={item.category} className="bg-gradient-to-br from-[#0d1b3e] to-[#080d1a] border border-blue-900/60 hover:border-[#1E90FF]/50 rounded-2xl p-6 transition-all group relative overflow-hidden">
                <div className="absolute top-3 right-3">
                  <span className="bg-[#1E90FF]/20 border border-[#1E90FF]/40 text-[#1E90FF] text-xs font-black px-2 py-1 rounded-lg">COMING SOON</span>
                </div>
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <span className="text-[#1E90FF] text-xs font-bold">Accepting Applications</span>
                </div>
              </div>
            ))}
          </div>
          <div className="bg-gradient-to-r from-[#1E90FF]/10 to-[#0a1628]/10 border border-[#1E90FF]/20 rounded-2xl p-8 text-center">
            ...
            <a href="mailto:contact@athlynx.ai?subject=Partnership%20Inquiry%20-%20AthlynX" className="inline-block bg-gradient-to-r from-[#1E90FF] to-[#0a1628] text-black font-black px-10 py-4 rounded-xl text-lg hover:scale-105 transition-transform">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600/20 to-[#0a1628]/20 border border-[#1E90FF]/30 rounded-2xl p-10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="mailto:contact@athlynx.ai" className="bg-gradient-to-r from-blue-600 to-[#0a1628] text-white px-8 py-4 rounded-xl font-black text-lg hover:scale-105 transition-transform">
