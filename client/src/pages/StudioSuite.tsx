        ...
        <header className="mb-6 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-neutral-400">
              Build 27.1 · Match Day, Final Score. Save exports a PNG,
          ...
          {TABS.map((t) => (
            <button
              ...
              className={`px-4 py-2 text-sm font-semibold transition ${
                tab === t.id
                  ? "border-b-2 border-blue-400/40 text-blue-300"
...
function CaptionPublishDock({ graphicId, captions, onPublish, publishing }: CaptionPublishDockProps) {
  ...
  return (
    <div className="mt-8 rounded-lg border border-blue-400/40/30 bg-neutral-950 p-6">
        ...
        {captions.map((c, idx) => (
          <label
            ...
            className={`flex cursor-pointer items-start gap-3 rounded border p-3 text-sm transition ${
              selected === idx
                ? "border-blue-400/40 bg-blue-900/30/10"
      ...
      <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          type="button"
          className="rounded bg-blue-900/30 px-5 py-2 font-semibold text-black hover:bg-blue-900/30 disabled:opacity-50"
