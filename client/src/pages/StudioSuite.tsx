...
function CaptionPublishDock({ graphicId, captions, onPublish, publishing }: CaptionPublishDockProps) {
  ...
  return (
    <div className="mt-8 rounded-lg border border-yellow-500/30 bg-neutral-950 p-6">
      ...
      <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          type="button"
          className="rounded bg-yellow-500 px-5 py-2 font-semibold text-black hover:bg-yellow-400 disabled:opacity-50"
