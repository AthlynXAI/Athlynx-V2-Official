    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="container mx-auto px-4 py-10 max-w-5xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="text-amber-400 text-xs font-semibold tracking-wider">FOUNDER PODCAST</div>
        </div>
        ...
        {epsQ.isLoading ? (
          ...
          <div className="space-y-3">
            {episodes.map((ep: any) => (
              <Card
                key={ep.id}
                className="bg-slate-900 border-slate-800 hover:border-amber-600 transition-colors"
              >
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 text-xs text-slate-500 mb-1">
                        {ep.episodeNumber && (
                          <span className="text-amber-400">EP {ep.episodeNumber}</span>
                        )}
                        {ep.publishedAt && (
