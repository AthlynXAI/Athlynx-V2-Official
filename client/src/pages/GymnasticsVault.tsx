/**
 * GymnasticsVault — Canonical Less-Is-More sport page (Gymnastics)
 *
 * Generated from the DiamondGrind canonical template (Lane 4, 2026-05-19).
 * Hero: single H1 "The Gymnastics Playbook." · ONE CTA · corner BETA chip · full-bleed athlete media.
 *
 * Spec lock: docs/specs/SPORT_PAGE_DESIGN_SPEC.md
 * X-theme: black canvas, accent #A855F7, NO gold/yellow/amber.
...
// =====================================================================
// SPORT TOKEN — GymnasticsVault (Gymnastics)
// =====================================================================
const SPORT = {
  name: "Gymnastics",
  pageTitle: "Gymnastics Vault",
  accent: "#A855F7",
  accentSoft: "rgba(168,85,247,0.12)",
  accentRing: "rgba(168,85,247,0.40)",
  emblem: "",
  trpcSport: "Gymnastics",
  ctaLabel: "Get Assessed",
  heroPhoto: "/sport-hero/gymnastics-hero.jpg",
  heroPhotoFallback: "/og-image.png",
  closingTagline: "90 MINUTES. ONE SCORE. FOREVER CHANGED.",
};

const DISCIPLINES = ["Vault", "Bars", "Beam"] as const;
type Discipline = (typeof DISCIPLINES)[number];

const PILLARS_BY_DISCIPLINE: Record<Discipline, { name: string; sample: number; pro: number; ncaa: number }[]> = {
  "Vault": [
    { name: "Run", sample: 82, pro: 80, ncaa: 70 },
    { name: "Block", sample: 75, pro: 78, ncaa: 68 },
    { name: "Rotation", sample: 78, pro: 79, ncaa: 70 },
    { name: "Landing", sample: 76, pro: 79, ncaa: 70 },
  ],
  "Bars": [
    { name: "Casts", sample: 78, pro: 80, ncaa: 70 },
    { name: "Release", sample: 81, pro: 82, ncaa: 71 },
    { name: "Pirouette", sample: 79, pro: 81, ncaa: 71 },
    { name: "Dismount", sample: 76, pro: 80, ncaa: 70 },
  ],
  "Beam": [
    { name: "Mount", sample: 80, pro: 81, ncaa: 70 },
    { name: "Series", sample: 73, pro: 79, ncaa: 68 },
    { name: "Leap", sample: 78, pro: 80, ncaa: 71 },
    { name: "Dismount", sample: 76, pro: 80, ncaa: 70 },
  ],
};
...
const STATS_FIELDS = [
  { label: "Best D-Score", key: "vaultDScore", placeholder: "5.4", group: "Vault" },
  { label: "Best E-Score", key: "vaultEScore", placeholder: "9.2", group: "Vault" },
  { label: "Vault", key: "vaultName", placeholder: "Yurchenko Double", group: "Vault" },
  { label: "Best D-Score", key: "barsDScore", placeholder: "5.8", group: "Bars" },
  { label: "Best E-Score", key: "barsEScore", placeholder: "9.1", group: "Bars" },
  { label: "Release", key: "barsRelease", placeholder: "Tkatchev", group: "Bars" },
  { label: "Best D-Score", key: "beamDScore", placeholder: "5.6", group: "Beam" },
  { label: "Best E-Score", key: "beamEScore", placeholder: "8.9", group: "Beam" },
  { label: "Mount", key: "beamMount", placeholder: "Press Handstand", group: "Beam" },
  { label: "Floor D-Score", key: "floorDScore", placeholder: "5.5", group: "Floor / Physical" },
  { label: "Tumbling Pass", key: "tumblingPass", placeholder: "Double Pike", group: "Floor / Physical" },
  { label: "Flexibility", key: "flexibility", placeholder: "Elite", group: "Floor / Physical" },
];

const STATS_GROUPS = ["Vault", "Bars", "Beam", "Floor / Physical"];

const PROGRAMS = [
  { title: "Elite Vault Progression", level: "Elite", duration: "8 weeks", sessions: 24, desc: "Run speed, block power, rotation." },
  { title: "Bars Release Mastery", level: "Intermediate", duration: "6 weeks", sessions: 18, desc: "Tkatchev, Jaeger, Pak — clean release." },
  { title: "Beam Confidence", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Series, leaps, dismount — under pressure." },
  { title: "Floor Tumbling Power", level: "All Levels", duration: "4 weeks", sessions: 12, desc: "Double pikes, layouts, dance through." },
  { title: "Mental Performance", level: "All Levels", duration: "Ongoing", sessions: null, desc: "Routine confidence, big-meet focus." },
  { title: "College Recruit Prep", level: "Elite", duration: "3 weeks", sessions: 9, desc: "NCAA Gymnastics · D1 scholarship-ready." },
];
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-5">
                ...
                <div className="grid grid-cols-2 gap-1.5 mb-3">
                  {[
    "4-week vault program",
    "Improve bars release",
    "College recruit checklist",
