 ...
 * All platforms talk together here: FB, X, TikTok, LinkedIn
    ...
    <div className="space-y-4">
      <div className="bg-gradient-to-r from-[#1a3a8f] to-[#0d1f3c] border border-blue-700 rounded-xl p-4">
        ...
        <div className="text-blue-400 text-xs leading-relaxed">
          Link your X, TikTok, LinkedIn, and YouTube. AthlynX pulls your content in and lets you cross-post to all of them through approved publishing workflows — the reverse funnel that brings every platform back here.
        </div>
      </div>
      ...
      <div className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <div className="text-blue-400 text-xs">Post once on AthlynX — goes to X, TikTok, LinkedIn simultaneously</div>
          </div>
        </div>
    ...
    <div className="space-y-4">
      ...
      {showAdd && (
        <div className="bg-[#1a3a8f] border border-blue-700 rounded-xl p-4 space-y-3">
          {[{ label: "Brand Name", key: "brandName", placeholder: "Gatorade..." },
      ...
      {(myDeals as any[]).map((d: any) => (
        <div key={d.id} className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-xs font-bold px-2 py-1 rounded-full ${d.status === "active" ? "bg-green-900 text-green-400" : d.status === "pending" ? "bg-blue-900/30 text-blue-300" : "bg-gray-800 text-gray-400"}`}>{d.status?.toUpperCase()}</span>
          </div>
        ...
        <div className="bg-gradient-to-r from-[#1a3a8f] to-[#1a2a4a] border border-blue-700 rounded-xl p-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#1E90FF]/60 mt-0.5">BE THE LEGACY.™</p>
            </div>
