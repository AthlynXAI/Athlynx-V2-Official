...
const labels = [
  ...
  ["Verified School", "eligibility, enrollment, and approved school or team data."],
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.35),transparent_35%),linear-gradient(135deg,#030817_0%,#061a3d_52%,#020617_100%)]">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/browse-athletes" className="rounded-xl bg-cyan-400 px-5 py-3 text-sm font-black text-slate-950 shadow-lg shadow-cyan-500/20 transition hover:bg-cyan-300">
                Browse Athletes
              </Link>
            <Link href="/ai-recruiter" className="rounded-xl border border-white/20 bg-white/10 px-5 py-3 text-sm font-black text-white transition hover:bg-white/15">
                Open AI Recruiter
              </Link>
          </div>
        </div>
