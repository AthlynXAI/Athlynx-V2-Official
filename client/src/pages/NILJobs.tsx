...
const TIERS = [
  ...
  { id: "rising", label: "📈 Rising Star", color: "bg-blue-900/30/40 text-blue-300 border-blue-400/40/40", desc: "5K–25K followers" },
...
const CAREER_LADDER = [
  ...
  { tier: "📈 Rising Star", range: "$500–$5K/mo", req: "1K+ followers, 3+ deals", color: "border-blue-400/40", active: false },
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-xl font-black text-white">AthlynX <span className="text-blue-300">JOBS</span></span>
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-10">
            <span className="inline-block px-4 py-1 bg-blue-900/30/20 text-blue-300 rounded-full text-sm font-semibold mb-4">
              💼 NIL HEADHUNTER & JOBS PLATFORM
            </span>
            <h1 className="text-4xl md:text-6xl font-black text-white mb-4">
              Your Worth. <span className="text-blue-300">Your Market.</span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { label: "Active Jobs", value: "2,847", icon: Briefcase, color: "text-blue-300" },
          ...
          {activeTab === "jobs" && (
            <div>
              ...
              <div className="flex flex-col md:flex-row gap-3 mb-6">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-blue-400/40/50"
                  />
                </div>
                  ...
                  {TIERS.map(tier => (
                    <button
                      ...
                      className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap border transition-all ${
                        activeTier === tier.id
                          ? "bg-blue-900/30 text-black border-blue-400/40"
                          : `${tier.color} hover:border-blue-400/40/50`
                      }`}
                    >
                      {tier.label}
                    </button>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filtered.map(job => (
                  <div key={job.id} className="bg-[#0d1a3a] border border-blue-900/40 rounded-2xl p-5 hover:border-blue-400/40/40 transition-all group">
                    ...
                    <button className="w-full bg-gradient-to-r from-blue-500 to-blue-300 text-black font-black py-2.5 rounded-xl text-sm hover:from-blue-500 hover:to-blue-300 transition-all">
                      Apply Now →
                    </button>
                  </div>
                ))}
          ...
          {activeTab === "score" && (
            <div className="max-w-2xl mx-auto">
              <div className="bg-[#0d1a3a] border border-blue-900/40 rounded-2xl p-8 text-center mb-6">
                <div className="text-6xl font-black text-blue-300 mb-2">742</div>
                ...
                <div className="w-full bg-white/10 rounded-full h-3 mb-2">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-300 h-3 rounded-full" style={{ width: "74%" }} />
                </div>
                  ...
                  <div key={i} className="bg-[#0d1a3a] border border-blue-900/40 rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <factor.icon className="w-4 h-4 text-blue-300" />
              ...
              <div className="bg-blue-900/20 border border-blue-700/30 rounded-2xl p-5">
                ...
                <ul className="space-y-2 text-sm text-blue-300">
                  ...
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-blue-300 flex-shrink-0" />Connect social accounts (adds +100 pts)</li>
                  <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-blue-300 flex-shrink-0" />Complete first NIL deal (adds +150 pts)</li>
          ...
          {activeTab === "ladder" && (
            <div className="max-w-2xl mx-auto">
                ...
                {CAREER_LADDER.map((rung, i) => (
                  <div key={i} className={`bg-[#0d1a3a] border-l-4 ${rung.color} border border-blue-900/40 rounded-2xl p-5 ${rung.active ? "ring-2 ring-blue-500/30" : ""}`}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {rung.active && <span className="px-2 py-0.5 bg-blue-900/30/20 text-blue-300 text-xs font-bold rounded-full border border-blue-400/40/30">YOU ARE HERE</span>}
                    </div>
              ...
              <div className="mt-8 bg-gradient-to-r from-blue-500/10 to-blue-300/5 border border-blue-400/40/20 rounded-2xl p-6 text-center">
              ...
              <div className="bg-[#0d1a3a] border border-blue-900/40 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: "Sport(s)", placeholder: "All Sports..." },
                  ].map((field, i) => (
                    <div key={i}>
                      ...
                      <input
                        ...
                        className="w-full bg-[#1a2a4a] border border-blue-800 text-white text-sm rounded-xl px-4 py-3 placeholder-blue-600 focus:outline-none focus:border-blue-400/40/50"
                      />
                    </div>
                  ))}
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#1a2a4a] border border-blue-800 text-white text-sm rounded-xl px-4 py-3 placeholder-blue-600 focus:outline-none focus:border-blue-400/40/50 resize-none"
                    />
                  </div>
                  <button className="w-full bg-gradient-to-r from-blue-500 to-blue-300 text-black font-black py-4 rounded-xl text-base hover:from-blue-500 hover:to-blue-300 transition-all">
