          ...
          {activeTab === "jobs" && (
            <div>
                    ...
                    <button
                      ...
                      className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap border transition-all ${
                        activeTier === tier.id
                          ...
                          : `${tier.color} hover:border-blue-500/50`
                      }`}
                    >
                      {tier.label}
                    </button>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filtered.map(job => (
                  <div key={job.id} className="bg-[#0d1a3a] border border-blue-900/40 rounded-2xl p-5 hover:border-blue-500/40 transition-all group">
                    ...
                    <button className="w-full bg-gradient-to-r from-blue-500 to-blue-400 text-black font-black py-2.5 rounded-xl text-sm hover:from-blue-400 hover:to-blue-300 transition-all">
                      Apply Now →
                    </button>
                  </div>
                ))}
                  ...
                  {[
                    ...
                    <div key={i}>
                      ...
                      <input
                        ...
                        className="w-full bg-[#1a2a4a] border border-blue-800 text-white text-sm rounded-xl px-4 py-3 placeholder-blue-600 focus:outline-none focus:border-blue-500/50"
                      />
                    </div>
                  ))}
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#1a2a4a] border border-blue-800 text-white text-sm rounded-xl px-4 py-3 placeholder-blue-600 focus:outline-none focus:border-blue-500/50 resize-none"
                    />
                  </div>
