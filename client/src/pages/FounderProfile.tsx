  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-center md:items-end gap-6 mb-8">
              ...
              <div className="relative">
                <div className="w-36 h-36 md:w-44 md:h-44 rounded-2xl overflow-hidden border-2 border-cyan-500/40 bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-950 flex flex-col items-center justify-center shadow-2xl shadow-cyan-500/10">
                  ...
                  <div className="relative mt-2 px-3 py-1 rounded-full border border-cyan-400/35 bg-cyan-400/10 text-[10px] md:text-xs font-bold uppercase tracking-[0.18em] text-cyan-200">{profile.avatarSubline}</div>
                  <div className="relative mt-3 text-[10px] font-semibold uppercase tracking-[0.26em] text-white/45">AthlynXAI</div>
                </div>
                {profile.verified && (
                  <div className="absolute -bottom-2 -right-2 w-9 h-9 rounded-full bg-cyan-500 border-2 border-slate-950 flex items-center justify-center">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-cyan-400 text-sm md:text-base mb-2">{profile.handle}</p>
            ...
            <Card className="mt-5 bg-white/5 border-cyan-500/20 overflow-hidden">
              <img
      ...
      <section className="container px-4 md:px-5 pb-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-black text-white mb-4 flex items-center gap-2">
            <Briefcase className="w-5 h-5 text-cyan-400" /> Profile Roles
          </h2>
          <div className="flex flex-wrap gap-2">
            {profile.positions.map((p) => (
              <Badge key={p} className="bg-cyan-500/15 text-cyan-300 border-cyan-500/30 text-sm px-3 py-1.5">
                {p}
              </Badge>
            ))}
          </div>
      ...
      <section className="container px-4 md:px-5 pb-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-black text-white mb-4 flex items-center gap-2">
            <Zap className="w-5 h-5 text-cyan-400" /> NIL Profile Pillars
          </h2>
          <div className="grid md:grid-cols-2 gap-4">
            {profile.strengths.map((s) => {
              const Icon = s.icon;
              return (
                <Card key={s.label} className="bg-white/5 border-white/10 hover:border-cyan-500/40 transition-colors">
                  <CardContent className="p-5">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-cyan-400 font-black text-lg">{s.score}</span>
                    </div>
      ...
      <section className="container px-4 md:px-5 pb-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-black text-white mb-4 flex items-center gap-2">
            <Hammer className="w-5 h-5 text-cyan-400" /> Founder Story
          </h2>
      ...
      <section className="container px-4 md:px-5 pb-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-black text-white mb-4 flex items-center gap-2">
            <Trophy className="w-5 h-5 text-cyan-400" /> Journey Record
          </h2>
              ...
              <Card key={i} className="bg-white/5 border-white/10">
                <CardContent className="p-5">
                  <div className="flex flex-col md:flex-row md:items-start gap-3">
                    <Badge className="bg-cyan-500/15 text-cyan-300 border-cyan-500/30 shrink-0 self-start">
                      {item.year}
                    </Badge>
        ...
        <div className="max-w-5xl mx-auto">
          <Card className="bg-gradient-to-br from-slate-900 to-slate-950 border-cyan-500/30">
            <CardContent className="p-6 md:p-10">
              ...
              <p className="text-cyan-400 font-bold text-sm">{profile.quote.attribution}</p>
