      ...
      <div className="space-y-4 pb-20 lg:pb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs bg-[#1E90FF] text-white px-2 py-0.5 rounded-full font-bold">BLEND</span>
              </div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          {([
            ...
            { id: "hashtags", label: "#⃣ Hashtags" },
            { id: "tips", label: " Tips" },
          ] as const).map(tab => (
            <button key={tab.id} onClick={() => setActiveTab(tab.id as typeof activeTab)}
              className={`flex-shrink-0 px-4 py-2.5 rounded-xl font-bold text-sm transition-all ${
                activeTab === tab.id ? "bg-[#1E90FF] text-white" : "bg-[#1a2a4a] text-blue-300 hover:bg-[#1a3a6a]"
              }`}>
              {tab.label}
            </button>
          ))}
        ...
        {activeTab === "caption" && (
          <div className="bg-[#0d1f3c] border border-[#1E90FF] rounded-xl p-5 space-y-4">
            ...
            <button onClick={() => captionMutation.mutate({ platform: captionForm.platform, contentType: captionForm.contentType, context: captionForm.context || "Athletic achievement", sport: captionForm.sport, includeHashtags: true })}
              ...
              className="w-full bg-gradient-to-r from-[#1E90FF] to-blue-700 hover:from-[#1E90FF] hover:to-blue-600 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-2">
            ...
            {captionResult && (
              <div className="bg-[#0a1628] border border-[#1E90FF] rounded-xl p-4">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-[#1E90FF] font-bold text-sm"> AI Captions</h4>
        ...
        {activeTab === "bio" && (
          <div className="bg-[#0d1f3c] border border-[#1E90FF] rounded-xl p-5 space-y-4">
            ...
            <button onClick={() => bioMutation.mutate({ platform: bioForm.platform, athleteName: user?.name || "Athlete", sport: bioForm.sport || "Athlete", school: bioForm.school || undefined, position: bioForm.position || undefined, achievements: bioForm.achievements || undefined })}
              ...
              className="w-full bg-gradient-to-r from-blue-700 to-[#0a1628] hover:from-blue-600 hover:to-[#0a1628] disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-2">
              {bioMutation.isPending ? <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> Writing...</> : " Write My Bio"}
            </button>
            {bioResult && (
              <div className="bg-[#0a1628] border border-blue-900 rounded-xl p-4">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-blue-500 font-bold text-sm"> AI Bio Options</h4>
        ...
        {activeTab === "plan" && (
          <div className="bg-[#0d1f3c] border border-[#1E90FF] rounded-xl p-5 space-y-4">
            ...
            <button onClick={() => planMutation.mutate({ sport: planForm.sport || "College Sport", season: planForm.season, goals: planForm.goals || "Grow audience and attract NIL deals", platforms: planForm.platforms })}
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-[#0a1628] hover:from-blue-500 hover:to-[#0a1628] disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-2">
              ...
              <div className="bg-[#0a1628] border border-blue-800 rounded-xl p-4">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button
                    ...
                    className="text-xs text-[#00C2FF] hover:text-white border border-[#00C2FF] px-2 py-1 rounded-lg disabled:opacity-50"
                  >
        ...
        {activeTab === "hashtags" && (
          <div className="space-y-3">
            <div className="bg-[#0d1f3c] border border-[#1E90FF] rounded-xl p-5">
              <h3 className="text-white font-bold text-lg mb-4">#⃣ Hashtag Sets by Sport & Goal</h3>
            ...
            <div className="bg-[#0d1f3c] border border-[#1E90FF] rounded-xl p-5">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: "Best Times to Post", icon: "", color: "border-[#00C2FF]", content: "Instagram: 6-9 AM and 5-8 PM EST. Twitter/X: 8-10 AM and 6-9 PM EST. TikTok: 7-9 AM, 12-3 PM, and 7-11 PM EST. Post when your audience is most active — typically before school/work and after dinner." },
                  { title: "Highlight Reel Checklist", icon: "", color: "border-[#1E90FF]", content: "Keep it under 90 seconds. Lead with your best play in the first 5 seconds. Include your name, position, school, and graduation year in the first frame. Add upbeat music. End with contact info. Update it every season." },
                  { title: "NIL-Ready Content", icon: "", color: "border-blue-600", content: "Brands look for athletes who post consistently, engage authentically, and align with their values. Showcase your personality, not just your stats. Document your journey — brands buy into stories, not just highlights." },
                  { title: "Engagement Over Followers", icon: "", color: "border-[#1E90FF]", content: "A 10K follower account with 8% engagement is worth more to a brand than a 100K account with 0.5% engagement. Reply to comments, ask questions in your captions, and build a real community." },
                  { title: "Cross-Platform Strategy", icon: "", color: "border-[#1E90FF]", content: "Create once, distribute everywhere. Film a training video → post the full version on YouTube → cut a 60-second version for Instagram Reels → cut a 15-second version for TikTok → post a still frame on Twitter with a link. One piece of content, four platforms." },
                ].map((tip, ti) => (
                ...
                <div className="bg-gradient-to-br from-[#1E90FF]/50 to-[#1530a0] border border-[#1E90FF]/60 rounded-xl p-5 text-center">
                  ...
                  <button onClick={() => setActiveTab("caption")}
                    className="bg-[#1E90FF] hover:bg-[#1E90FF] text-white font-bold py-2.5 px-6 rounded-xl transition-colors">
