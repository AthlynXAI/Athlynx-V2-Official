...
// Phased public operator contacts only. Private phones, personal emails, advisors, and unapproved operators stay out of the public app.
const TEAM = [
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Quick Stats */}
            <Card className="bg-[#1a365d]/50 border-blue/30">
              <CardContent className="pt-6">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-3xl font-bold text-blue-400">{selectedPlatforms.length}</p>
          ...
          <div className="space-y-6">
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className="text-blue-400 border-blue/50"
                  ...
                  <div
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-all ${
                      selectedTeam.includes(member.name)
                        ? 'bg-blue-900/20 border border-blue/50'
                        : 'bg-white/5 border border-transparent hover:bg-white/10'
                    }`}
                  >
            ...
            <Card className="bg-[#1a365d]/50 border-cyan-500/30">
              ...
              <CardContent className="grid grid-cols-3 gap-2">
                <a 
                  href="mailto:contact@athlynx.ai?subject=AthlynXAI%20Contact" 
                  target="_blank"
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-4 bg-gradient-to-r from-cyan-500/20 to-blue/20 border border-cyan-500/30 rounded-full px-8 py-4">
            <span className="text-cyan-400 font-bold">FIRST MEDIA CONGLOMERATE</span>
            <span className="text-gray-400">•</span>
            <span className="text-blue-400">Fox News + ESPN + Social Media</span>
            <span className="text-gray-400">•</span>
