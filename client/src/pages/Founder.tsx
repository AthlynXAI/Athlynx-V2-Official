      ...
      <section className="container mx-auto px-4 py-12 max-w-5xl">
        <div className="flex items-start gap-6 flex-col sm:flex-row">
          {founder?.avatarUrl ? (
            ...
            <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-600 flex items-center justify-center text-4xl font-bold">
              CD
            </div>
          )}
          <div className="flex-1">
            <div className="text-blue-400 text-xs font-semibold tracking-wider mb-2">FOUNDER</div>
      ...
      <section className="container mx-auto px-4 max-w-5xl">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link href="/founder/podcast">
            <Card className="bg-slate-900 border-slate-800 hover:border-blue-500/40 transition-colors cursor-pointer">
              ...
              <Link key={ep.id} href={`/founder/podcast/${ep.slug}`}>
                <Card className="bg-slate-900 border-slate-800 hover:border-blue-500/40 transition-colors cursor-pointer h-full">
                  <CardContent className="p-4">
                    ...
                    {ep.episodeNumber && (
                      <div className="text-xs text-blue-400 mb-1">EP {ep.episodeNumber}</div>
                    )}
