      ...
      <main className="relative min-h-screen overflow-hidden bg-[#020617] text-white">
        ...
        <section className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-wrap items-center gap-3">
            ...
            <span className="rounded-full border border-yellow-400/30 bg-yellow-400/10 px-4 py-2 text-xs font-black uppercase tracking-[0.25em] text-yellow-200">
              Road to Omaha 2026
            </span>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-5">
                  <div className="text-3xl font-black text-yellow-300">{regionals.length}</div>
            ...
            <div className="athlynx-premium-watermark-card rounded-[2rem] border border-white/10 p-6 shadow-2xl backdrop-blur">
              <p className="text-xs font-black uppercase tracking-[0.25em] text-yellow-200">Mississippi watch · MSU loyalty</p>
              ...
              <article key={regional.regional} className="rounded-[1.5rem] border border-white/10 bg-white/[0.045] p-5 shadow-xl backdrop-blur transition hover:border-blue-300/40 hover:bg-white/[0.07]">
                ...
                <div className="mt-5 grid gap-5 md:grid-cols-[0.85fr_1.15fr]">
                  ...
                  <div className="space-y-4">
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-yellow-200">Opening matchups</p>
