...
import { GraduationCap, TrendingUp, Star, Shield, DollarSign, Users, FileText, Heart, ArrowRight, CheckCircle, Zap, Target, BookOpen, Award, Briefcase, Home, ChevronRight, Play, Lock, Globe, Mic, Camera, BarChart3, Building2, Handshake, Clock, Rocket, Activity, Trophy } from "lucide-react";
...
const STAGES = [
  {
    ...
    tools: [
      ...
      { icon: Camera, title: "Highlight Reel Studio", desc: "Upload, edit, and share your best moments. AthlynX automatically formats your highlights for every platform — Hudl, Instagram.", href: "/media-showcase", cta: "Create Reel" },
    ]
  },
  {
    id: "college",
