...
const EMAIL = "contact@athlynx.ai";
...
We reserve the right to remove any User Content that violates these Terms or that we determine, in our sole discretion, is harmful, offensive, or otherwise objectionable.`,
  },
  {
    ...
    body: `The Platform and its original content (excluding User Content), features, source code, workflows, designs, product concepts, evidence packages, data models, medical-signal monitoring architecture, and functionality are and will remain the exclusive property of ${COMPANY}, Chad A. Dozier Sr., affiliated AthlynX entities, and/or their licensors as applicable. The Platform is protected by copyright, trademark, trade secret, contract, and other laws. Our trademarks, trade dress, logos, source code, workflows, and product architecture may not be used in connection with any product or service without prior written consent.

AthlynX™, AthlynXAI™, AXN™, AVN™, AthlynX Medical™, Medical BioSignal OS™, GlucoAthlete OS™, BioSignal Channel™, The Athlete's Playbook™, the AthlynX logo, Dozier Holdings Group, Softmor Inc., and related marks, names, logos, workflows, founder-tested Libre Link proof paths, and platform assets are proprietary marks and intellectual property. Formal trademark and copyright filings may be handled by counsel. All rights reserved.`,
  },
  {
    id: "privacy",
    title: "9. Privacy",
...
IN NO EVENT SHALL THE COMPANY'S TOTAL LIABILITY TO YOU EXCEED THE AMOUNT YOU PAID TO THE COMPANY IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.`,
  ...
  },
  {
    ...
    body: `These Terms shall be governed by and construed in accordance with the laws of the State of Texas, without regard to its conflict of law provisions.

Any dispute arising from or relating to these Terms or the Platform shall first be subject to good-faith negotiation between the parties. If the dispute cannot be resolved through negotiation within 30 days, it shall be submitted to binding arbitration in Harris County, Texas, under the rules of the American Arbitration Association.
