...
const LIVE_EVENTS = [
  ...
  { icon: "🔄", text: "Devon Carter entered Transfer Portal from Klein HS", time: "8m ago", color: "text-blue-300" },
  ...
  { icon: "🏆", text: "Westlake HS Football ranked #1 in Texas 6A", time: "22m ago", color: "text-blue-300" },
      ...
      <div className="min-h-screen bg-[#040c1a] pb-24">
        ...
        <div className="bg-[#0a1628] border-b border-blue-900/40 px-4 py-2 flex items-center gap-2 overflow-hidden">
          <div className="flex items-center gap-1.5 shrink-0">
            <Trophy size={10} className="text-red-400 animate-pulse" />
        ...
        <div className="bg-gradient-to-b from-[#0a1628] to-[#040c1a] px-4 pt-5 pb-4">
          <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-2 mb-1">
              ...
              <div className="text-[10px] font-black tracking-[0.3em] text-blue-300 uppercase">AthlynX Rankings</div>
            </div>
                ...
                {filteredLeaderboard.map((athlete, i) => (
                  <div key={athlete.rank} onClick={() => setSelectedAthlete(selectedAthlete === i ? null : i)}
                    ...
                    <div className="col-span-1 flex flex-col items-center justify-center gap-0.5">
                      <span className={`text-sm font-black ${athlete.rank <= 3 ? "text-blue-300" : "text-white"}`}>
                    ...
                    <div className="col-span-5 flex items-center gap-2">
                      <div className={`w-9 h-9 rounded-xl flex items-center justify-center text-white font-black text-xs shrink-0 ${
                        athlete.rank === 1 ? "bg-gradient-to-br from-blue-500 to-blue-500" :
                        athlete.rank === 2 ? "bg-gradient-to-br from-slate-400 to-slate-600" :
                        athlete.rank === 3 ? "bg-gradient-to-br from-blue-600 to-blue-400" :
          ...
          {activeTab === "rankings" && (
            <>
              ...
              <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl overflow-hidden">
                <div className="bg-gradient-to-r from-blue-500/20 to-blue-500/10 px-4 py-3 border-b border-blue-400/40/20">
                  <div className="text-xs font-black text-blue-300 tracking-widest uppercase">AthlynX College Top 25</div>
                ...
                {top25.map((team, i) => (
                  <div key={i} className="flex items-center gap-3 px-4 py-3 border-b border-blue-900/20 hover:bg-blue-900/10 transition-colors">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-black text-sm shrink-0 ${
                      team.rank === 1 ? "bg-blue-900/30 text-black" : team.rank === 2 ? "bg-slate-400 text-black" : team.rank === 3 ? "bg-blue-900/40 text-white" : "bg-blue-900/50 text-blue-300"
                    }`}>{team.rank}</div>
                    <div className="flex-1">
            ...
            <>
              ...
              <div className="bg-[#0d1e3c] border border-blue-800/50 rounded-2xl overflow-hidden">
                ...
                {draft.picks.map((pick, i) => (
                  <div key={i} className="flex items-center gap-3 px-4 py-3 border-b border-blue-900/20 hover:bg-blue-900/10 transition-colors">
                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center font-black text-sm shrink-0 ${pick.pick === 1 ? "bg-blue-900/30 text-black" : "bg-blue-900/50 text-blue-300"}`}>#{pick.pick}</div>
              ...
              <div className="bg-gradient-to-r from-[#0066ff]/10 to-[#00c2ff]/5 border border-dashed border-[#0066ff]/40 rounded-2xl p-5 text-center">
                <Trophy size={24} className="text-blue-300 mx-auto mb-2" />
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  { label: "New Offers", val: "38", Icon: Award, color: "text-blue-300" },
                ].map((s, i) => (
