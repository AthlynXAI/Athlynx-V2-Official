            ...
            {ADVISORS.map((adv, i) => (
              <div key={i} className={`bg-white/5 border rounded-2xl p-6 hover:bg-white/10 transition-all ${adv.featured ? "border-green-400/40" : "border-white/10"}`}>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  ...
                  <div className="bg-white/5 rounded-lg p-2 text-center"><div className="text-xs font-black text-blue-300">Free</div><div className="text-xs text-slate-400">Consultation</div></div>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {SERVICES.map((svc, i) => {
              ...
              const colors: Record<string, string> = {
                ...
                yellow: "text-blue-300 bg-blue-900/30/20 border-blue-400/40/30",
                orange: "text-blue-400 bg-blue-500/20 border-blue-400/30",
