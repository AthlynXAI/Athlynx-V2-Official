...
import { FileText, Handshake, DollarSign, Search, Star, Shield, CheckCircle, ArrowRight, ChevronRight, Users, Briefcase, Award, TrendingUp, Globe, Phone, Mail, Clock, Zap, Lock, Download, Building2, Heart, Mic, Camera, Filter, MapPin, ExternalLink, Trophy } from "lucide-react";
...
const CONTRACTS = [
  ...
  { id: 2, title: "Social Media Sponsorship Contract", category: "endorsement", desc: "For TikTok, YouTube, and X campaigns. Includes post requirements, approval rights, and FTC disclosure.", popular: true, tier: "free", pages: "3–5 pages" },
