...
const PRODUCTS = [
  ...
  // ── Robotics / AI Training Research — GATED UNTIL PARTNER APPROVAL ──
  {
    ...
    badgeColor: "bg-blue-600",
    name: "AthlynXAI Training Bot Preview",
    tagline: "Governed athlete training intelligence; partner hardware details stay private until finalized",
    specs: ["Human-supervised training workflows", "Athlete profile integration", "Performance and recovery support language", "Connector-gated proof before external claims", "Request-access only until commercial terms are approved"],
    image: `/img-ai-software.jpg`,
    tag: "Request Access",
    featured: false,
    comingSoon: true,
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { id: "athlete_champion", name: "Athlete Champion", price: "$59.99", period: "/mo", badge: "Champion", badgeColor: "bg-blue-600", gradient: "from-blue-900/30 to-blue-950/40", border: "border-blue-500/30", desc: "Advanced NIL suite, AI brand deals, and dedicated coaching support.", features: ["Everything in Elite", "Advanced NIL Analytics", "AI Brand Deal Suite", "Dedicated Coaching Support", "Custom Athlete Landing Page", "Priority Recruiting Exposure", "Early Feature Access"], cta: "Become a Champion", planId: "athlete_champion" },
                { id: "athlete_mvp", name: "Athlete MVP", price: "$99.99", period: "/mo", badge: "MVP 🏆", badgeColor: "bg-blue-900/30", gradient: "from-blue-500/30 to-blue-950/40", border: "border-blue-400/40/30", desc: "The ultimate AthlynX experience — everything, plus 1-on-1 personal strategy.", features: ["Everything in Champion", "1-on-1 Personal Strategy Sessions", "VIP Recruiting Network Access", "White-Glove NIL Management", "Unlimited AI Credits/mo", "Custom Brand Kit", "Direct Line to AthlynX Team"], cta: "Go MVP", planId: "athlete_mvp" },
              ].map(plan => (
