    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a1628] via-[#0d1e36] to-[#0a1628]">
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-[#1E90FF]/20 rounded-full blur-3xl" />
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <motion.div variants={fadeInUp} className="mb-6">
              <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-[#1E90FF]/20 to-blue-600/20 border border-[#1E90FF]/30 mb-4">
                <Mic className="w-12 h-12 text-[#00C2FF]" />
              </div>
            </motion.div>
            
            <motion.div variants={fadeInUp} className="mb-4">
              <Badge className="bg-[#00C2FF]/20 text-[#00C2FF] border-[#00C2FF]/30 px-4 py-1">
                <span className="w-2 h-2 bg-[#00C2FF] rounded-full mr-2 animate-pulse inline-block" />
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-black text-white mb-6">
              THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E90FF] to-blue-500">STUDIO</span>
            </motion.h1>
            ...
            <motion.p variants={fadeInUp} className="text-lg text-[#00C2FF]/80 max-w-2xl mx-auto mb-8">
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/mindset">
                <Button variant="outline" className="border-[#1E90FF]/30 text-[#00C2FF] hover:bg-[#1E90FF]/20 px-8 py-6 text-lg rounded-full">
                  Read the Mindset
                </Button>
              </Link>
            </motion.div>
        ...
        <div className="container mx-auto">
          ...
          >
            <motion.div variants={fadeInUp}>
              <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
                WHAT TO <span className="text-[#00C2FF]">EXPECT</span>
              </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-[#1a3a5c]/50 to-[#0d1e36]/50 rounded-2xl p-8 border border-[#1E90FF]/30 text-center"
            >
              <Video className="w-12 h-12 text-[#00C2FF] mx-auto mb-4" />
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#1a3a5c]/50 to-[#0d1e36]/50 rounded-2xl p-8 border border-[#1E90FF]/30 text-center"
            >
              <Users className="w-12 h-12 text-[#1E90FF] mx-auto mb-4" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          >
            <motion.div variants={fadeInUp}>
              <Tv className="w-16 h-16 text-[#00C2FF] mx-auto mb-4" />
              <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
                SHOW <span className="text-[#00C2FF]">CATEGORIES</span>
              </h2>
              <p className="text-white/60 text-xl max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#0d1e36] to-[#0a1628]">
        <div className="container mx-auto">
          ...
          >
            <motion.div variants={fadeInUp}>
              <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
                CONTENT FOR <span className="text-[#1E90FF]">EVERYONE</span>
              </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {stakeholderContent.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-[#1a3a5c]/30 rounded-2xl p-6 border border-[#1E90FF]/30 hover:border-[#1E90FF]/30 transition-all"
              >
                ...
                <ul className="space-y-2">
                  {item.topics.map((topic, i) => (
                    <li key={i} className="text-white/60 flex items-center gap-2">
                      <span className="w-1.5 h-1.5 bg-[#1E90FF] rounded-full" />
                      {topic}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          >
            <motion.div variants={fadeInUp}>
              <Calendar className="w-16 h-16 text-[#00C2FF] mx-auto mb-4" />
              <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
                UPCOMING <span className="text-[#00C2FF]">EPISODES</span>
              </h2>
              <p className="text-white/60 text-xl max-w-2xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {upcomingEpisodes.map((episode, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-gradient-to-r from-[#1a3a5c]/50 to-[#0d1e36]/50 rounded-xl p-6 border border-[#1E90FF]/30 flex items-center justify-between"
              >
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-xl bg-[#1E90FF]/20 flex items-center justify-center">
                    <Play className="w-8 h-8 text-[#00C2FF]" />
                  </div>
                  <div>
                ...
                <div className="text-right">
                  <Badge className="bg-[#1E90FF]/20 text-[#00C2FF] border-[#1E90FF]/30 mb-1">
                    {episode.category}
                  </Badge>
      ...
      {/* Subscribe CTA */}
      <section className="py-20 px-4 bg-gradient-to-r from-[#1E90FF]/20 to-blue-600/10">
        <div className="container mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Headphones className="w-16 h-16 text-[#00C2FF] mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
              DON'T MISS AN <span className="text-[#00C2FF]">EPISODE</span>
            </h2>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          >
            <div className="bg-gradient-to-br from-[#1E90FF]/10 to-[#0a1628]/10 rounded-3xl p-12 border border-[#1E90FF]/20">
              <Star className="w-16 h-16 text-[#1E90FF] mx-auto mb-6" />
              <h2 className="text-3xl md:text-4xl font-black text-white mb-6">
                TOTAL <span className="text-[#1E90FF]">POSITIVITY</span>
              </h2>
              ...
              <p className="text-[#00C2FF] text-lg font-semibold">
