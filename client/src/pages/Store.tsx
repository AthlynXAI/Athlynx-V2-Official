...
const staticProducts = [
  ...
  { id: 29, sku: "BB-CATCHER-PRO", name: "All-Star System 7 Catcher's Set", category: "baseball", price: 599.99, image: "/img-baseball-bat.jpg", rating: 4.9, reviews: 89, description: "chest protector, leg guards", requiresQuote: false },
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                { name: "Champion", price: "$59.99", badge: "Champion", color: "border-blue-500/40 bg-blue-900/20", features: ["NIL Analytics", "Brand Deal Suite", "Custom Page", "Early Access"] },
                { name: "MVP", price: "$99.99", badge: "MVP 🏆", color: "border-blue-400/40/40 bg-blue-900/30/20", features: ["1-on-1 Strategy", "VIP Network", "Unlimited Credits", "Custom Brand Kit"] },
              ].map(plan => (
