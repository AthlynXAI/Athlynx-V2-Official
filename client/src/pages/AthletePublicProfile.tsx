...
import { ArrowLeft, Share2, Edit3, UserPlus, MessageCircle, CheckCircle, Shield, Lock, Zap, TrendingUp, BarChart2, Star, Award, Target, MapPin, DollarSign, Video, FileText, Users, Eye, Activity, ChevronRight, Flame, Cpu, BookOpen, Briefcase, Film, Trophy, Building2, ExternalLink, Camera, Play, Music2, Heart, RefreshCw, Download, Verified, Globe, Phone, Mail, Dumbbell, Timer, Ruler, Gauge, Percent, TrendingDown, PlayCircle, Flag, Clock, Info, ChevronDown, UserCheck, Handshake, School, Search, Filter, SlidersHorizontal, Calendar, GraduationCap } from "lucide-react";
...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; icon: any }> = {
  ...
  transferred: { label: "Transfer Portal", color: "text-blue-400", bg: "bg-blue-900/40/10 border-blue-500/40/30", icon: RefreshCw },
};
...
function XFactorRing({ score }: { score: number }) {
  ...
  const color = score >= 90 ? "#3B82F6" : score >= 80 ? "#00c2ff" : score >= 70 ? "#22c55e" : "#94a3b8";
...
function EPXDial({ score }: { score: number }) {
  ...
  const color = score >= 80 ? "#1E90FF" : score >= 60 ? "#3B82F6" : "#94a3b8";
...
function MetricBar({ label, value, unit, max, percentile, icon: Icon }: {
  ...
  const barColor = percentile >= 90 ? "#3B82F6" : percentile >= 75 ? "#00c2ff" : percentile >= 50 ? "#22c55e" : "#94a3b8";
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1.5 mt-1.5">
            ...
            <span className="text-blue-300 text-xs font-black">{best.score} X-Factor</span>
          </div>
        </div>
          ...
          <div key={i} className="flex items-center justify-between bg-[#0d1b3e] border border-white/10 rounded-xl px-4 py-3 hover:border-[#00c2ff]/30 transition-all group">
            ...
            <div className="flex items-center gap-2">
              <span className={`text-[10px] font-black px-2 py-0.5 rounded-full border ${
                ...
                c.div === "NAIA" ? "bg-blue-500/10 text-blue-400 border-blue-500/30" :
...
function AthletePublicProfileInner() {
  ...
  const TABS: { id: TabId; label: string; icon: any }[] = [
    ...
    { id: "news", label: "News", icon: Trophy },
        ...
        <div className="px-4 py-4">
          ...
          <div className="grid grid-cols-3 gap-3 mb-5">
            ...
            <div className="bg-[#0d1b3e] border border-white/10 rounded-2xl p-4 space-y-2">
              {[
                { label: "Posts", value: userPosts.length || 0, icon: Trophy },
              ...
              <div className="bg-[#0d1b3e] border border-white/10 rounded-2xl p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {[
                    ...
                    { label: "Weight", value: profile.weight ? `${profile.weight} lbs` : null, icon: Trophy },
            ...
            <div className="space-y-4">
              ...
              <div className="text-center py-4">
                <button className="text-[#00c2ff] text-sm font-black hover:underline flex items-center gap-1.5 mx-auto">
                  <Trophy className="w-4 h-4" /> Load More News
                </button>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { label: "Licensing", desc: "Name, image, likeness rights", icon: FileText, color: "text-blue-400" },
                ].map((cat, i) => (
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  { label: "X-Factor Score", value: xScore, icon: Zap, color: "text-blue-300" },
