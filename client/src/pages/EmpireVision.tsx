...
import { Rocket, TrendingUp, Globe, Building2, Cpu, Users, DollarSign, Heart, Dumbbell, Music, ShoppingBag, Shield, GraduationCap, Landmark, Home, ChevronRight, Zap, Target, Sparkles, Trophy } from "lucide-react";
...
function EmpireVisionInner() {
  ...
  const verticals = [
    ...
    { icon: Trophy, name: "Broadcasting", desc: "AthlynX TV", status: "2026", color: "rose", detail: "Live sports & athlete content" },
    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #0a1628 0%, #0d1f3c 50%, #061424 100%)' }}>
      ...
      <section className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 py-16">
        <div className="container px-5">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">
              AthlynXAI capabilities integrated throughout the entire ecosystem, making us the most intelligent athlete platform ever built.
            </p>
          </div>
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="container px-5 text-center">
          <p className="text-white/50 text-sm">© 2025 Dozier Holdings LLC. Building the Future of Athlete Success.</p>
        </div>
      </footer>
    <MobileBottomNav />
    </div>
