...
function EarlyAccessInner() {
  ...
  // Supabase OAuth redirects to /auth/callback automatically — no mutation needed here
  ...
  async function handleSocialSignIn(provider: string) {
    ...
    try {
      // Supabase OAuth redirects to /auth/callback — syncSupabaseUser is called there
      if (provider === 'google') await signInWithGoogle()
      else if (provider === 'apple') await signInWithApple()
      else if (provider === 'facebook') await signInWithFacebook()
      else await signInWithTwitter()
