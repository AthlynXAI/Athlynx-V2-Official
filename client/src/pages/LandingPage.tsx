...
const CHAMPIONSHIP_SPOTLIGHTS = [
  ...
  },
  {
    ...
    desc: "Women's College Softball gets the same stage. Mississippi State made history by reaching its first-ever Women's College World and the full field deserves national respect.",
    accent: "#ff4fd8",
  },
  {
    title: "Every Sport Counts",
    eyebrow: "Men's and Women's Championships",
    desc: "basketball, baseball, softball, soccer, track, volleyball, tennis, golf, wrestling, swimming, lacrosse, and every athlete chasing a championship belong on the same platform.",
    accent: "#0066ff",
  },
];
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input name="sport" type="text" placeholder="Baseball..."
                  className="w-full bg-[#050d1a] border border-[#0066ff]/20 rounded-xl px-4 py-3 text-white placeholder-[#4a6080] focus:outline-none focus:border-[#0066ff] transition-colors" />
              </div>
              <div>
