...
function severityColor(s: RuleRow["severity"]): string {
  ...
  if (s === "high") return "bg-amber-500/10 text-amber-300 border-amber-500/30";
      ...
      {q.isPending ? (
        ...
        <>
          ...
          <div className="max-w-6xl mx-auto px-4 pb-20 space-y-12">
            ...
            <div className="mt-12 p-6 bg-[#0a1628] border border-amber-500/30 rounded-xl">
              <h3 className="text-sm font-bold text-amber-300 uppercase tracking-wider mb-2">Important Disclaimer</h3>
