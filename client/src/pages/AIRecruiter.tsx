    ...
    return (
      <PlatformLayout title="AI Recruiter">
        <div className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-8 text-center">
          ...
          <a href="/signin" className="bg-[#00C2FF] hover:bg-[#00C2FF] text-white font-bold px-6 py-2.5 rounded-lg inline-block transition-colors">
            Sign In
          </a>
        </div>
      </PlatformLayout>
  ...
  return (
    <PlatformLayout title="AI Recruiter">
      <div className="space-y-4 pb-20 lg:pb-4">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#1a3a8f] to-[#1a2a4a] border border-[#00C2FF] rounded-xl p-5">
        ...
        <div className="flex gap-1 bg-[#1a3a8f] border border-blue-900 rounded-xl p-1">
          {[
            ...
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold rounded-lg transition-colors ${activeTab === tab.key ? 'bg-[#00C2FF] text-white' : 'text-blue-400 hover:text-white'}`}
            >
              {tab.label}
            </button>
          ))}
        ...
        {activeTab === "optimize" && (
          <div className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-5">
            ...
            <div className="space-y-3">
                ...
                {[
                  ...
                  <div key={f.key}>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0d1f3c] border border-blue-800 text-white text-sm rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#00C2FF] placeholder-blue-600"
                    />
                  </div>
                ))}
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0d1f3c] border border-blue-800 text-white text-sm rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#00C2FF]"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-[#0d1f3c] border border-blue-800 text-white text-sm rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#00C2FF] placeholder-blue-600 resize-none"
                />
              </div>
              <div>
              ...
              <button
                ...
                className="w-full bg-[#00C2FF] hover:bg-[#00C2FF] text-white font-black py-3 rounded-xl transition-colors disabled:opacity-50"
              >
            ...
            {optimizeResult && (
              <div className="mt-4 bg-[#1530a0] border border-[#00C2FF] rounded-xl p-4">
                ...
                <div className="flex gap-2 mt-3">
                  <button
                    ...
                    className="flex-1 border border-[#00C2FF] text-[#00C2FF] text-sm font-bold py-2 rounded-lg hover:bg-[#00C2FF] transition-colors"
                  >
                    Copy Analysis
                  </button>
                  <button
