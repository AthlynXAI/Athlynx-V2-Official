...
export const THE_THREE: readonly DoctrineMember[] = [
  {
...
/** @deprecated Use THE_THREE. Tony Locey has been suspended — access revoked by Master Admin. */
export const THE_FOUR = THE_THREE;
 ...
 */
export const THE_FOUR_ATHLYNX_EMAILS = THE_THREE.flatMap((m) => m.signIn) as readonly string[];
