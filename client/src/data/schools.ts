...
export const SCHOOLS: School[] = [
  ...
  { abbr: "UM",   name: "Michigan",          conference: "B1G", primary: "#00274C", secondary: "#FFCB05", espnId: 130, state: "MI" },
  ...
  { abbr: "USC",  name: "USC",               conference: "B1G", primary: "#990000", secondary: "#FFCC00", espnId: 30,  state: "CA" },
  { abbr: "UCLA", name: "UCLA",              conference: "B1G", primary: "#2774AE", secondary: "#FFD100", espnId: 26,  state: "CA" },
  ...
  // ── Mississippi & Local ──
  { abbr: "USM",  name: "Southern Miss",     conference: "SBC", primary: "#FFAB00", secondary: "#000000", espnId: 2572,state: "MS" },
