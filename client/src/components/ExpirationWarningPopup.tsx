    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
      <div className={`w-full max-w-md rounded-3xl border-2 p-8 shadow-2xl ${
        isExpired
          ...
          : "bg-[#040c1a] border-blue-400/40 shadow-blue-500/20"
      }`}>
        ...
        <div className="text-center mb-5">
          ...
          <div className={`inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-black tracking-widest uppercase ${
            isExpired
              ...
              : "bg-blue-900/30/10 border border-blue-400/40/30 text-blue-300"
          }`}>
            <span className={`w-2 h-2 rounded-full ${isExpired ? "bg-red-400" : "bg-blue-900/30"} animate-pulse`} />
