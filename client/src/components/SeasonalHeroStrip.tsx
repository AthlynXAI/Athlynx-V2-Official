  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-5">
        ...
        <Link href={featured.href} className="block group border border-[#1E90FF]/50 rounded-xl bg-gradient-to-r from-[#1E90FF]/15 via-black to-black p-4 md:p-5 mb-3 hover:border-[#1E90FF] hover:shadow-[0_0_32px_-8px_rgba(30,144,255,0.6)] transition"
        ...
        {rest.length > 0 && (
          <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 [&::-webkit-scrollbar]:h-1 [&::-webkit-scrollbar-thumb]:bg-[#1E90FF]/40 [&::-webkit-scrollbar-track]:bg-transparent">
            {rest.map((s) => (
              <Link key={s.label} href={s.href} className="flex-shrink-0 min-w-[200px] md:min-w-[220px] border border-white/10 rounded-lg bg-black/60 p-3 hover:border-[#1E90FF]/60 hover:bg-[#1E90FF]/5 transition group"
