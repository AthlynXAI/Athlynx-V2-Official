          ...
          {activeTab === "family" && (
            <div className="bg-[#050d1f] p-4 overflow-y-auto" style={{ height: 320 }}>
              <div className="text-center mb-4">
                <div className="text-2xl mb-2 font-black tracking-widest text-blue-300">LEG</div>
              ...
              {familyLegacy?.parentName ? (
                <div className="space-y-2 mb-4">
                  {familyLegacy.grandparentName && (
                    <div className="bg-blue-900/30/20 border border-blue-400/40/30 rounded-xl p-3">
                      <div className="text-blue-300 text-xs font-bold">GRANDPARENT</div>
                      <div className="text-white text-sm font-bold">{familyLegacy.grandparentName}</div>
                      <div className="text-blue-300/60 text-xs">Legacy Member</div>
                    </div>
                  )}
              ...
              <button className="w-full bg-gradient-to-r from-blue-500 to-blue-400 text-black font-black text-sm rounded-xl py-2.5 hover:from-blue-500 hover:to-blue-400 transition-all active:scale-[0.98]">
                + Link Family Member
              </button>
