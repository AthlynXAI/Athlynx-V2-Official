...
export default function PlatformLayout({ children, title }: PlatformLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#1a3a8f] text-white">
      ...
      {user && trialExpired && (
        <div className="bg-gradient-to-r from-red-900/40 to-blue-900/40 border-b border-red-700/50 text-center py-1.5 px-4 flex items-center justify-center gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            {user && (
              <div className="hidden sm:flex items-center gap-1 mr-1">
                ...
                <Link href="/billing">
                  <span className="inline-flex items-center gap-0.5 text-[10px] font-bold px-2 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/30 cursor-pointer hover:bg-blue-500/20 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 flex gap-4 lg:pb-4 pb-[calc(72px+env(safe-area-inset-bottom,0px))]">
        ...
        <aside className="hidden lg:flex flex-col w-64 shrink-0 gap-3">
          ...
          {/* DHG link */}
          <Link href="/dhg-empire" className="bg-[#1a3a8f] rounded-xl border border-blue-700/40 p-3 flex items-center gap-3 hover:bg-blue-900 hover:border-blue-500/60 transition-colors">
            ...
            <div>
              ...
              <div className="text-blue-400/70 text-xs">All 20+ Companies</div>
            </div>
          </Link>
          ...
          {user && trialExpired ? (
            <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-12">
              <div className="max-w-lg w-full bg-gradient-to-br from-[#0a1628] via-[#1a3a8f] to-[#0a1628] border-2 border-red-500/60 rounded-3xl p-8 text-center shadow-2xl">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  {([{name:"STARTER",price:"$29",color:"#0066ff"},{name:"PRO",price:"$79",color:"#00c2ff",popular:true},{name:"ELITE",price:"$149",color:"#7c3aed"}] as any[]).map((p: any) => (
                    <Link key={p.name} href="/billing" className="rounded-xl border p-3 hover:scale-105 transition-all cursor-pointer block" style={{borderColor: p.color + '44', backgroundColor: p.color + '11'}}>
                      {p.popular && <div className="text-[9px] font-black text-blue-400 mb-1">POPULAR</div>}
                ...
                <Link href="/billing" className="block w-full bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-400 hover:to-blue-600 text-white font-black text-lg py-3 rounded-xl transition-all shadow-xl hover:scale-105">
                  CHOOSE YOUR PLAN →
                </Link>
