          ...
          <div className="hidden md:flex flex-1 max-w-xs mx-4">
            <div className="relative w-full">
              <input
                ...
                className="w-full bg-[#2A0710]/75 text-white text-sm rounded-full px-4 py-2 pl-9 border border-[#5D1725]/70 focus:outline-none focus:border-[#F6C453] placeholder-sky-100/45"
              />
