...
const SPORT_COLORS: Record<string, { from: string; to: string; accent: string }> = {
  ...
  Basketball: { from: "#3a1a0a", to: "#1f0a05", accent: "#3B82F6" },
  Baseball: { from: "#0a1a3a", to: "#051020", accent: "#60a5fa" },
  Soccer: { from: "#0a3a1a", to: "#051f0a", accent: "#34d399" },
  "Track & Field": { from: "#3a2a0a", to: "#1f1505", accent: "#3B82F6" },
...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; dot: string }> = {
  ...
  transferred: { label: "Transfer Portal", color: "text-blue-300", bg: "bg-blue-900/30/15 border-blue-400/40/30", dot: "bg-blue-900/30" },
};
        ...
        <div className="relative px-4 pb-4">
          ...
          <div className="grid grid-cols-3 gap-2 mb-3">
            {[
              ...
              keyStat ? { label: keyStat.label, value: `${keyStat.value}`, color: "text-blue-300" } :
