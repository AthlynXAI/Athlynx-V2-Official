      ...
      <div className="p-5 md:p-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-5">
          ...
          <div className="flex flex-col gap-2 md:items-end shrink-0">
            <Link href="/diamond-grind-iq" className="inline-flex items-center gap-2 rounded-2xl bg-[#1E90FF] px-5 py-3 text-sm font-black uppercase tracking-wider text-white shadow-lg shadow-[#1E90FF]/30 transition hover:bg-[#0080FF]">
                Open Diamond Grind
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </Link>
            <Link href="/signup" className="inline-flex items-center gap-2 rounded-2xl border border-[#1E90FF]/50 px-5 py-2.5 text-[11px] font-black uppercase tracking-wider text-white/85 transition hover:bg-[#1E90FF]/10 hover:text-white">
...
function RoadToOmahaIntro() {
  return (
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-5">
      ...
      <Link href="/brackets/mcws" className="text-[11px] font-black tracking-[0.22em] uppercase text-[#1E90FF] hover:text-white transition self-start md:self-auto">
          Open full bracket →
        </Link>
    </div>
  );
        ...
        <div className="mb-6 rounded-3xl border-2 border-[#1E90FF]/70 bg-[#020817] p-3 shadow-[0_0_34px_rgba(30,144,255,0.32)] md:p-5">
          ...
          <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
            <div className="min-w-0 rounded-2xl border border-[#1E90FF]/35 bg-black/35 p-3">
              <Link href="/brackets/mcws" className="mb-3 block text-xs font-black uppercase tracking-[0.2em] text-white hover:text-[#1E90FF]">MCWS Live · Regionals to Omaha →</Link>
              <LiveRegionalScoreboard sport="baseball" />
              <RegionalBracketTree sport="baseball" />
            </div>
            <div className="min-w-0 rounded-2xl border border-[#1E90FF]/35 bg-black/35 p-3">
              <Link href="/brackets/wcws" className="mb-3 block text-xs font-black uppercase tracking-[0.2em] text-white hover:text-[#1E90FF]">WCWS Live · Regionals to OKC →</Link>
