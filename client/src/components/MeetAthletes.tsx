        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {coaches.map((coach: any) => (
              <div key={coach.id} className="bg-slate-900/60 border border-slate-800 rounded-2xl p-4 flex items-center gap-3 hover:border-blue-400/40/50 transition-all">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-blue-300 text-xs">{getSportEmoji(coach.sport)} {coach.sport}</div>
                </div>
        ...
        <div className="flex flex-col items-center text-center cursor-pointer">
          ...
          {athlete.xScore > 0 && (
            <div className="flex items-center gap-1 mt-1.5">
              ...
              <span className="text-blue-300 text-xs font-black">{athlete.xScore}</span>
            </div>
          )}
